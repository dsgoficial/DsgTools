...
<qgis version="2.16.0-Nødebo" simplifyAlgorithm="0" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="sigla">
      <widgetv2config fieldEditable="1" constraint="" labelOnTop="0" constraintDescription="" notNull="0">
        <value key="AC" value="1"/>
        <value key="AL" value="2"/>
        <value key="AM" value="4"/>
        <value key="AP" value="3"/>
        <value key="BA" value="5"/>
        <value key="CE" value="6"/>
        <value key="DF" value="7"/>
        <value key="Desconhecido" value="0"/>
        <value key="ES" value="8"/>
        <value key="GO" value="9"/>
        <value key="MA" value="10"/>
        <value key="MG" value="13"/>
        <value key="MS" value="12"/>
        <value key="MT" value="11"/>
        <value key="PA" value="14"/>
        <value key="PB" value="15"/>
        <value key="PE" value="17"/>
        <value key="PI" value="18"/>
        <value key="PR" value="16"/>
        <value key="RJ" value="19"/>
        <value key="RN" value="20"/>
        <value key="RO" value="22"/>
        <value key="RR" value="23"/>
        <value key="RS" value="21"/>
        <value key="SC" value="24"/>
        <value key="SE" value="26"/>
        <value key="SP" value="25"/>
        <value key="TO" value="27"/>
      </widgetv2config>
    </edittype>
