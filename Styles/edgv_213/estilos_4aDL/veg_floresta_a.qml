  ...
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="especiepredominante">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        ...
        <value key="Babaçu" value="41"/>
        <value key="Bambu" value="11"/>
        <value key="Cipó" value="10"/>
        <value key="Misto" value="98"/>
        <value key="Não identificado" value="96"/>
        <value key="Palmeira" value="17"/>
        <value key="Sororoca" value="12"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="caracteristicafloresta">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Bosque" value="3"/>
        <value key="Desconhecido" value="0"/>
        <value key="Floresta" value="1"/>
        <value key="Mata" value="2"/>
      </widgetv2config>
    </edittype>
    ...
    <edittype widgetv2type="ValueMap" name="classificacaoporte">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        ...
        <value key="Arbórea" value="1"/>
        <value key="Desconhecido" value="0"/>
        <value key="Misto" value="98"/>
      </widgetv2config>
    </edittype>
  </edittypes>
  <renderer-v2 attr="caracteristicafloresta" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Floresta"/>
      <category render="true" symbol="1" value="2" label="Mata"/>
      <category render="true" symbol="2" value="3" label="Bosque"/>
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        ...
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="86,244,47,255"/>
      ...
      <symbol alpha="1" type="fill" name="1">
        ...
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@1@1">
            <layer pass="0" class="SvgMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="#007700"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="symbol/landuse_coniferous.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="#007700"/>
              <prop k="outline_width" v="1"/>
              <prop k="outline_width_map_unit_scale" v="0,0"/>
              <prop k="outline_width_unit" v="MM"/>
              <prop k="scale_method" v="area"/>
      ...
      <symbol alpha="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="127,211,189,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
