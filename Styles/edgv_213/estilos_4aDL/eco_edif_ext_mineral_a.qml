...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipodivisaocnae">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecido" value="0"/>
        <value key="Extração de Carvão Mineral" value="10"/>
        <value key="Extração de Minerais Metálicos" value="13"/>
        <value key="Extração de Minerais Não-Metálicos" value="14"/>
        <value key="Extração de Petróleo e Serviços Relacionados" value="11"/>
        <value key="Outros" value="99"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipodivisaocnae" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="10" label="Extração de Carvão Mineral"/>
      <category render="true" symbol="1" value="11" label="Extração de Petróleo e Serviços Relacionados"/>
      <category render="true" symbol="2" value="13" label="Extração de Minerais Metálicos"/>
      <category render="true" symbol="3" value="14" label="Extração de Minerais Não-Metálicos"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="1">
        ...
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@1@2">
            <layer pass="0" class="SvgMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="#fbfbfb"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="tourist/tourist_fountain.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="#000000"/>
      ...
      <symbol alpha="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="201,202,205,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="4">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="244,125,217,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
