...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipoediflazer">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Anfiteatro" value="5"/>
        <value key="Centro cultural" value="7"/>
        <value key="Cinema" value="6"/>
        <value key="Desconhecido" value="0"/>
        <value key="Estádio" value="1"/>
        <value key="Ginásio" value="2"/>
        <value key="Museu" value="3"/>
        <value key="Outros" value="99"/>
        <value key="Plataforma de pesca" value="8"/>
        <value key="Teatro" value="4"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipoediflazer" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Estádio"/>
      <category render="true" symbol="1" value="2" label="Ginásio"/>
      <category render="true" symbol="2" value="3" label="Museu"/>
      <category render="true" symbol="3" value="4" label="Teatro"/>
      <category render="true" symbol="4" value="5" label="Anfiteatro"/>
      <category render="true" symbol="5" value="6" label="Cinema"/>
      <category render="true" symbol="6" value="7" label="Centro cultural"/>
      <category render="true" symbol="7" value="8" label="Plataforma de pesca"/>
      <category render="true" symbol="8" value="99" label="Outros"/>
      <category render="true" symbol="9" value="0" label="Desconhecido"/>
    </categories>
    <symbols>
        ...
        <layer pass="0" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@1@1">
            <layer pass="0" class="SvgMarker" locked="0">
              ...
              <prop k="color" v="#000000"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="sport/sport_leisure_centre.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="#000000"/>
      ...
      <symbol alpha="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="51,87,213,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="199,102,28,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="no"/>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="117,217,132,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
        ...
        <layer pass="0" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@3@1">
            <layer pass="0" class="SvgMarker" locked="0">
              ...
              <prop k="color" v="#000000"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="tourist/tourist_theatre.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="#000000"/>
        ...
        <layer pass="0" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@5@1">
            <layer pass="0" class="SvgMarker" locked="0">
              ...
              <prop k="color" v="#000000"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="tourist/tourist_cinema2.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="#000000"/>
      ...
      <symbol alpha="1" type="fill" name="6">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="215,117,228,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="7">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,193,255"/>
          <prop k="outline_style" v="dash"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
        ...
        <layer pass="0" class="CentroidFill" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@7@1">
            <layer pass="0" class="SvgMarker" locked="0">
              ...
              <prop k="color" v="#0000c1"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="shopping/shopping_tackle.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="#000000"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="149,142,112,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
