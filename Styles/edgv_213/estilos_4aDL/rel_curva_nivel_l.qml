...
<qgis version="2.18.7" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="cota" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="142,162,59,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <aliases>
    ...
    <alias field="indice" index="4" name=""/>
...
def my_form_open(diálogo, camada, feição):
  ...
  <defaults>
    ...
    <default field="geometriaaproximada" expression=""/>
    <default field="cota" expression=""/>
    <default field="depressao" expression=""/>
    <default field="indice" expression=""/>
    <default field="lenght_otf" expression=""/>
  </defaults>
