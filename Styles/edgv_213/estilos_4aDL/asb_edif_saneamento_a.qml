...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipoedifsaneam">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecido" value="0"/>
        <value key="Incinerador" value="7"/>
        <value key="Outros" value="99"/>
        <value key="Recalque" value="3"/>
        <value key="Tratamento de esgoto" value="5"/>
        <value key="Usina de reciclagem" value="6"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipoedifsaneam" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="3" label="Recalque"/>
      <category render="true" symbol="1" value="5" label="Tratamento de esgoto"/>
      <category render="true" symbol="2" value="6" label="Usina de reciclagem"/>
      <category render="true" symbol="3" value="7" label="Incinerador"/>
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="232,136,192,255"/>
      ...
      <symbol alpha="1" type="fill" name="4">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="188,31,202,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="233,11,189,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
