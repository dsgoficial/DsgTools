...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipoedifenergia">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        ...
        <value key="Chaminé" value="5"/>
        <value key="Depósito" value="4"/>
        <value key="Desconhecido" value="0"/>
        <value key="Oficinas" value="2"/>
        <value key="Outros" value="99"/>
        <value key="Segurança" value="3"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipoedifenergia" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Administração"/>
      <category render="true" symbol="1" value="2" label="Oficinas"/>
      <category render="true" symbol="2" value="3" label="Segurança"/>
      <category render="true" symbol="3" value="4" label="Depósito"/>
      <category render="true" symbol="4" value="5" label="Chaminé"/>
    ...
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="219,152,113,255"/>
      ...
      <symbol alpha="1" type="marker" name="1">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="shopping/shopping_diy.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="194,110,127,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
