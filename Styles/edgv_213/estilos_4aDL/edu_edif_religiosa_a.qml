...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipoedifrelig">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Centro" value="3"/>
        <value key="Convento" value="5"/>
        <value key="Desconhecido" value="0"/>
        <value key="Igreja" value="1"/>
        <value key="Mesquita" value="6"/>
        <value key="Mosteiro" value="4"/>
        <value key="Outros" value="99"/>
        <value key="Sinagoga" value="7"/>
        <value key="Templo" value="2"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="ensino">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecido" value="0"/>
        <value key="Não" value="2"/>
        <value key="Sim" value="1"/>
    ...
    <edittype widgetv2type="TextEdit" name="religiao">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="id_org_religiosa">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="tipoedifrelig" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Igreja"/>
      <category render="true" symbol="1" value="2" label="Templo"/>
      <category render="true" symbol="2" value="3" label="Centro"/>
      <category render="true" symbol="3" value="4" label="Mosteiro"/>
      <category render="true" symbol="4" value="5" label="Convento"/>
      <category render="true" symbol="5" value="6" label="Mesquita"/>
      <category render="true" symbol="6" value="7" label="Sinagoga"/>
      <category render="true" symbol="7" value="99" label="Outros"/>
      <category render="true" symbol="8" value="0" label="Desconhecido"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="2,1,4,255"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="236,140,108,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
