...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipomacchav">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Chavascal" value="2"/>
        <value key="Desconhecido" value="0"/>
        <value key="Macega" value="1"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipomacchav" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Macega"/>
      <category render="true" symbol="1" value="2" label="Chavascal"/>
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        ...
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="50,196,28,255"/>
      ...
      <symbol alpha="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="119,146,219,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
        ...
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@1@1">
            <layer pass="0" class="SvgMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="#96c608"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="symbol/landuse_swamp.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
