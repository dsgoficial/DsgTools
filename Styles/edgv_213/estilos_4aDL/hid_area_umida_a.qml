...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipoareaumida">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Arenoso" value="4"/>
        <value key="Desconhecido" value="0"/>
        <value key="Lamacento" value="3"/>
      </widgetv2config>
    </edittype>
  </edittypes>
  <renderer-v2 attr="tipoareaumida" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="3" label="Lamacento"/>
      <category render="true" symbol="1" value="4" label="Arenoso"/>
