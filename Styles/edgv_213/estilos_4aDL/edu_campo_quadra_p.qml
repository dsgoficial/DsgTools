...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipocampoquadra">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Basquete" value="2"/>
        <value key="Desconhecido" value="0"/>
        <value key="Futebol" value="1"/>
        <value key="Hipismo" value="5"/>
        <value key="Outros" value="99"/>
        <value key="Poliesportiva" value="6"/>
        <value key="Pólo" value="4"/>
        <value key="Tênis" value="7"/>
        <value key="Vôlei" value="3"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipocampoquadra" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Futebol"/>
      <category render="true" symbol="1" value="2" label="Basquete"/>
      <category render="true" symbol="2" value="3" label="Vôlei"/>
      <category render="true" symbol="3" value="4" label="Pólo"/>
      <category render="true" symbol="4" value="5" label="Hipismo"/>
      <category render="true" symbol="5" value="6" label="Poliesportiva"/>
      <category render="true" symbol="6" value="7" label="Tênis"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="3">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="sport/sport_horse_racing.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="#000000"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="152,244,223,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
