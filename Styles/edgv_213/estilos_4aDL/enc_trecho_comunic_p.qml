...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="posicaoreledific">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Adjacente a edificação" value="17"/>
        <value key="Isolado" value="14"/>
        <value key="Sobre edificação" value="18"/>
      </widgetv2config>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="alturaestimada">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="posicaoreledific" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="14" label="Isolado"/>
      <category render="true" symbol="1" value="17" label="Adjacente a edificação"/>
      <category render="true" symbol="2" value="18" label="Sobre edificação"/>
    </categories>
    <symbols>
