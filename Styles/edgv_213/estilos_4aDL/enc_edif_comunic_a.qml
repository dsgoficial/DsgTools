...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="modalidade">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Dados" value="4"/>
        <value key="Desconhecido" value="0"/>
        <value key="Outras" value="99"/>
        <value key="Radiocomunicação" value="1"/>
        <value key="Radiodifusão/som" value="5"/>
        <value key="Radiodifusão/som e imagem" value="2"/>
        <value key="Telefonia" value="3"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="tipoedifcomunic">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Central comutação e transmissão" value="2"/>
        <value key="Centro de operações" value="1"/>
        <value key="Desconhecido" value="0"/>
        <value key="Estação radio-base" value="3"/>
        <value key="Estação repetidora" value="4"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="TextEdit" name="id_complexo_comunicacao">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="tipoedifcomunic" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Centro de operações"/>
      <category render="true" symbol="1" value="2" label="Central comutação e transmissão"/>
      <category render="true" symbol="2" value="3" label="Estação radio-base"/>
      <category render="true" symbol="3" value="4" label="Estação repetidora"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="240,158,122,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
