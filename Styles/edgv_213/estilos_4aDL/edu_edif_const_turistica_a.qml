...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipoedifturist">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Cruzeiro" value="9"/>
        <value key="Desconhecido" value="0"/>
        <value key="Estátua" value="10"/>
        <value key="Mirante" value="11"/>
        <value key="Monumento" value="12"/>
        <value key="Outros" value="99"/>
        <value key="Panteão" value="13"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="ovgd">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecido" value="0"/>
        <value key="Não" value="2"/>
        <value key="Sim" value="1"/>
  ...
  <renderer-v2 attr="tipoedifturist" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="9" label="Cruzeiro"/>
      <category render="true" symbol="1" value="10" label="Estátua"/>
      <category render="true" symbol="2" value="11" label="Mirante"/>
      <category render="true" symbol="3" value="12" label="Monumento"/>
      <category render="true" symbol="4" value="13" label="Panteão"/>
      <category render="true" symbol="5" value="99" label="Outros"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="101,150,207,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="4">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="155,130,225,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="6">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="232,183,131,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
