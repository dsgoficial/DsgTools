...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="tipodivisaocnae" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category render="true" symbol="8" value="23" label="Fabricação de Coque Refino de Petróleo Elaboração de Combustíveis Nucleares&#xa;e Produção de Álcool"/>
      ...
      <category render="true" symbol="17" value="32" label="Fabricação de Material Eletrônicode Aparelhos e Equipamentos de &#xa;Comunicações"/>
      <category render="true" symbol="18" value="33" label="Instumentos de Precisão e Ópticos Equipamentos para Automação Industrial &#xd;&#xa;Cronômetros e Relógios"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="9">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="234,190,233,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="rectangle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
