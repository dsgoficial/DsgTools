...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="tipodepgeral" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="32" label="Armazém"/>
      <category render="true" symbol="1" value="10" label="Composteira"/>
      <category render="true" symbol="2" value="11" label="Depósito frigorífico"/>
      <category render="true" symbol="3" value="8" label="Galpão "/>
      <category render="true" symbol="4" value="19" label="Reservatório de Combustível"/>
      <category render="true" symbol="5" value="9" label="Silo "/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="3">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="128,172,215,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
