...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipofontedagua">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        ...
        <value key="Olho d`água" value="3"/>
        <value key="Poço" value="1"/>
        <value key="Poço Artesiano" value="2"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="qualidagua">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecida" value="0"/>
        <value key="Mineral" value="3"/>
        <value key="Não potável" value="2"/>
        <value key="Potável" value="1"/>
        <value key="Salobra" value="4"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipofontedagua" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Poço"/>
      <category render="true" symbol="1" value="2" label="Poço Artesiano"/>
      <category render="true" symbol="2" value="3" label="Olho d`água"/>
