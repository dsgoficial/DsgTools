...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipodepsaneam">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Aterro controlado" value="6"/>
        <value key="Aterro sanitário" value="5"/>
        <value key="Depósito de lixo" value="4"/>
        <value key="Desconhecido" value="0"/>
        <value key="Outros" value="99"/>
        <value key="Tanque" value="1"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="construcao">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Aberta" value="2"/>
        <value key="Fechada" value="1"/>
    ...
    <edittype widgetv2type="ValueMap" name="finalidade">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Armazenamento" value="8"/>
        <value key="Desconhecido" value="0"/>
        <value key="Tratamento" value="2"/>
      </widgetv2config>
    </edittype>
    ...
    <edittype widgetv2type="ValueMap" name="residuo">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecido" value="0"/>
        <value key="Líquido" value="1"/>
        <value key="Sólido" value="2"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="tiporesiduo">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Chorume" value="15"/>
        <value key="Desconhecido" value="0"/>
        <value key="Esgoto" value="9"/>
        <value key="Lixo domiciliar e comercial" value="12"/>
        <value key="Lixo séptico" value="14"/>
        <value key="Lixo tóxico" value="13"/>
  ...
  <renderer-v2 attr="tipodepsaneam" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="6" label="Aterro controlado"/>
      <category render="true" symbol="1" value="5" label="Aterro sanitário"/>
      <category render="true" symbol="2" value="4" label="Depósito de lixo"/>
      <category render="true" symbol="3" value="1" label="Tanque"/>
      <category render="true" symbol="4" value="99" label="Outros"/>
      <category render="true" symbol="5" value="0" label="Desconhecido"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="229,136,82,255"/>
      ...
      <symbol alpha="1" type="marker" name="3">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="156,235,200,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
