...
<qgis version="2.8.2-Wien" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="tipotunel">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Passagem subterrânea sob via" value="2"/>
        <value key="Túnel" value="1"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="modaluso">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Dutos" value="7"/>
        <value key="Ferroviário" value="5"/>
        <value key="Metroviário" value="6"/>
        <value key="Rodoferroviário" value="8"/>
    ...
    <edittype widgetv2type="ValueMap" name="posicaopista">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        ...
        <value key="Superpostas" value="13"/>
      </widgetv2config>
    </edittype>
  ...
  <renderer-v2 attr="tipotunel" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="1" label="Túnel"/>
      <category render="true" symbol="1" value="2" label="Passagem subterrânea sob via"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="244,5,13,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="142,205,148,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
