...
- Corrige potenciais injeções de SQL nos geradores de SQL do PostGIS, Spatialite e Geopackage e no gerenciamento de complexos: identificadores e valores literais passam a ser escapados antes de entrar na query;
- Remove script morto que rodava eval() sobre resposta de rede não confiável (reverse_geocode.py, sem uso em nenhum fluxo do plugin);
