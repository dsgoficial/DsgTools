...
from DsgTools.core.GeometricTools.graphHandler import fetch_connected_nodes, buildAuxFlowGraph
...
class BuildAuxFlowGraphTestCase(unittest.TestCase):
    ...
    def test_build_flow_dict_case3(self):
        ...
        G.add_edges_from([
            ...
            (4, 3), (4, 5), (4, 7),
            (6, 7), (8, 7),
            (8, 9), (9, 10), (10, 14), (14, 13), (13, 8), # loop
            (12, 13), (12, 11),
            (15, 14), (15, 16),
            (17, 10), (17, 18), (26, 17), (26, 25), (27, 26), (27, 28), (27, 29),
            (31, 18), (30, 31), (31, 32),
            (19, 18), (19, 20),
            (34, 19), (34, 21), (34, 22),
            (22, 23), (22, 33),
        ...
        expectedG.add_edges_from([
            ...
            (9, 10), (14, 10), (14, 15), (15, 16),
            (10, 17), (17, 18), (25, 26), (26, 27), (28, 27), (27, 29),
    ...
    def test_build_flow_dict_case4(self):
        ...
        G.add_edges_from([
            ...
            (14, 16),
            (21, 22), (22, 20), (24, 23),
            (24, 22), (24, 25), (26, 25), (27, 26), (28, 26), (28, 29), (32, 29), (30, 29), (30, 31),
            (32, 33), (33, 34), (33, 35),
        ])
        expectedG = nx.DiGraph()
        expectedG.add_edges_from([
            ...
            (14, 18), (14, 16),
            (18, 15),
            (20, 22), (21, 22), (22, 24), (23, 24), (24, 25), (25, 26), (27, 26), (26, 28), (28, 29),
            (34, 33), (35, 33), (33, 32), (32, 29),
            (29, 30), (30, 31),
        ])
