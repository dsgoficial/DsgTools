<!DOCTYPE qgis PUBLIC 'http://mrcc.com/qgis.dtd' 'SYSTEM'><qgis version="2.6.0-Brighton" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0"> 
  <edittypes> 
    ...
    <edittype widgetv2type="TextEdit" name="id_complexo_desportivo_lazer"> 
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/> 
    </edittype>
    ...
    <edittype widgetv2type="ValueMap" name="tipoedifturist">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Cruzeiro" value="12"/>
        <value key="Estátua" value="13"/>
        <value key="Mirante" value="14"/>
        <value key="Monumento" value="15"/>
        <value key="Panteão" value="16"/>
        <value key="Chafariz" value="17"/>
        <value key="Chaminé" value="18"/>
        <value key="Escultura" value="19"/>
        <value key="Obelisco" value="20"/>
        <value key="Torre" value="21"/>
        <value key="Desconhecido" value="95"/>
        <value key="Outros" value="99"/>
      </widgetv2config>
    </edittype> 
    ...
    <edittype widgetv2type="ValueMap" name="tombada">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Não" value="0"/>
        <value key="Sim" value="1"/>
      </widgetv2config>
