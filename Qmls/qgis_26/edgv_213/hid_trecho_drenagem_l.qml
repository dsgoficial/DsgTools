<!DOCTYPE qgis PUBLIC 'http://mrcc.com/qgis.dtd' 'SYSTEM'><qgis version="2.6.0-Brighton" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="coincidecomdentrode">
    ...
    </edittype>    <edittype widgetv2type="ValueMap" name="regime">
      <widgetv2config fieldEditable="1" labelOnTop="0">
    ...
    </edittype>    <edittype widgetv2type="ValueMap" name="navegabilidade">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecida" value="0"/>
        <value key="Navegável" value="1"/>
        <value key="Não navegável" value="2"/>
      </widgetv2config>
    </edittype>    <edittype widgetv2type="ValueMap" name="eixoprincipal">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Sim" value="1"/>
        <value key="Não" value="2"/>
      </widgetv2config>
    </edittype>    <edittype widgetv2type="ValueMap" name="dentrodepoligono">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Sim" value="1"/>
        <value key="Não" value="2"/>
      </widgetv2config>
    </edittype>    <edittype widgetv2type="ValueMap" name="compartilhado">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Sim" value="1"/>
        <value key="Não" value="2"/>
      </widgetv2config>
      ...
      <widgetv2config fieldEditable="1" labelOnTop="0">
        ...
        <value key="Represa/açude" value="10"/>
        <value key="Vala" value="11"/>
        <value key="Queda dágua" value="12"/>
        <value key="Corredeira" value="13"/>
        <value key="Eclusa" value="14"/>
        <value key="Terreno sujeito a inundação" value="15"/>
        <value key="Foz marítima" value="16"/>
