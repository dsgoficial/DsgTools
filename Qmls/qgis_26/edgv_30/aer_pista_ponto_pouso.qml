<!DOCTYPE qgis PUBLIC 'http://mrcc.com/qgis.dtd' 'SYSTEM'><qgis version="2.6.0-Brighton" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0"> 
  <edittypes> 
    ...
    <edittype widgetv2type="TextEdit" name="id_complexo_aeroportuario"> 
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/> 
    </edittype>
    ...
    <edittype widgetv2type="ValueMap" name="tipopista">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Pista de taxiamento" value="3"/>
        <value key="Pista de Pouso" value="4"/>
        <value key="Heliponto" value="5"/>
      </widgetv2config>
    </edittype> 
    ...
    <edittype widgetv2type="ValueMap" name="usopista">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Particular" value="1"/>
        <value key="Público/militar" value="2"/>
        <value key="Militar" value="3"/>
        <value key="Público" value="4"/>
        <value key="Público e Militar" value="5"/>
        <value key="Público e Civil" value="6"/>
        <value key="Desconhecido" value="95"/>
      </widgetv2config>
    </edittype> 
    ...
    <edittype widgetv2type="ValueMap" name="homologacao">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Não" value="0"/>
        <value key="Sim" value="1"/>
        <value key="Desconhecido" value="95"/>
