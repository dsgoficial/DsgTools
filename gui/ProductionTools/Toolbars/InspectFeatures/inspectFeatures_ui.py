...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_zoom.setMinimumSize(QtCore.QSize(0, 20))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_zoom.setText(_translate("Form", "Scale"))
...
from qgis.gui import QgsFieldExpressionWidget, QgsMapLayerComboBox, QgsScaleWidget
