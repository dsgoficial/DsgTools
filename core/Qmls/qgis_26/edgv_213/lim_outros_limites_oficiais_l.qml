...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="5" type="QString" name="Faixa de fronteira"/>
              <Option value="4" type="QString" name="Lateral marítima"/>
              <Option value="1" type="QString" name="Mar territorial"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="6" type="QString" name="Plataforma continental jurídica"/>
              <Option value="2" type="QString" name="Zona contígua"/>
              <Option value="3" type="QString" name="Zona econômica exclusiva"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipooutlimofic" index="6" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipooutlimofic" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipooutlimofic"/>
