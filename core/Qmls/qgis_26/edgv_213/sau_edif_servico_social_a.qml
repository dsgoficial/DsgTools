...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoclassecnae">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="32" type="QString" name="85.31-6 - Serviços Sociais com alojamento"/>
              <Option value="33" type="QString" name="85.32-4 - Serviços Sociais sem alojamento"/>
              <Option value="0" type="QString" name="Desconhecido"/>
    ...
    <field name="id_org_servico_social">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="id_org_servico_social" index="8" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_org_servico_social" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="id_org_servico_social" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_org_servico_social"/>
