...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="7" type="QString" name="Incinerador"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="3" type="QString" name="Recalque"/>
              <Option value="5" type="QString" name="Tratamento de esgoto"/>
              <Option value="6" type="QString" name="Usina de reciclagem"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoedifsaneam" index="7" name=""/>
    <alias field="id_complexo_saneamento" index="8" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifsaneam" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoedifsaneam"/>
