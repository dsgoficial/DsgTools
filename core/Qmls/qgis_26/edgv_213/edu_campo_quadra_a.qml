...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipocampoquadra">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="2" type="QString" name="Basquete"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="1" type="QString" name="Futebol"/>
              <Option value="5" type="QString" name="Hipismo"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="6" type="QString" name="Poliesportiva"/>
              <Option value="4" type="QString" name="Pólo"/>
              <Option value="7" type="QString" name="Tênis"/>
              <Option value="3" type="QString" name="Vôlei"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipocampoquadra" index="6" name=""/>
    <alias field="id_complexo_lazer" index="7" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipocampoquadra" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipocampoquadra"/>
