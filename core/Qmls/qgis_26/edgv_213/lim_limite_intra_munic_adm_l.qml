...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipolimintramun">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="5" type="QString" name="Bairro"/>
              <Option value="1" type="QString" name="Distrital"/>
              <Option value="3" type="QString" name="Perímetro urbano legal"/>
              <Option value="4" type="QString" name="Região administrativa"/>
              <Option value="2" type="QString" name="Sub-distrital"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipolimintramun" index="6" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipolimintramun" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipolimintramun"/>
