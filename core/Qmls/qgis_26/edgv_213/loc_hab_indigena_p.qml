...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias field="coletiva" index="4" name=""/>
    <alias field="isolada" index="5" name=""/>
    <alias field="id_aldeia_indigena" index="6" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="coletiva" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="isolada" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="id_aldeia_indigena" constraints="0" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="coletiva"/>
    <constraint exp="" desc="" field="isolada"/>
    <constraint exp="" desc="" field="id_aldeia_indigena"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
