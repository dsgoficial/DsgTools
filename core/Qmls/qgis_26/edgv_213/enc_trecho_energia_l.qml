...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="3" type="QString" name="Distribuição"/>
              <Option value="2" type="QString" name="Transmissão"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="especie" constraints="1" exp_strength="0" notnull_strength="1"/>
    ...
    <constraint unique_strength="0" field="tensaoeletrica" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="numcircuitos" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="especie"/>
    ...
    <constraint exp="" desc="" field="tensaoeletrica"/>
    <constraint exp="" desc="" field="numcircuitos"/>
