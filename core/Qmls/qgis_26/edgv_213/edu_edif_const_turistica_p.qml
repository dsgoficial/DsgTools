...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoedifturist">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="9" type="QString" name="Cruzeiro"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="10" type="QString" name="Estátua"/>
              <Option value="11" type="QString" name="Mirante"/>
              <Option value="12" type="QString" name="Monumento"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="13" type="QString" name="Panteão"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoedifturist" index="7" name=""/>
    <alias field="ovgd" index="8" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifturist" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoedifturist"/>
