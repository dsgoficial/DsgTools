...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="4" type="QString" name="Interferência com hidrografia"/>
              <Option value="3" type="QString" name="Interferência com localidades"/>
              <Option value="6" type="QString" name="Interferência com vias"/>
              <Option value="5" type="QString" name="Interferência com áreas especiais"/>
              <Option value="7" type="QString" name="Outras interferências"/>
              <Option value="2" type="QString" name="Risco geotécnico"/>
              <Option value="1" type="QString" name="Subestação de válvulas e/ou bombas"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipolocalcrit" index="4" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipolocalcrit" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipolocalcrit"/>
