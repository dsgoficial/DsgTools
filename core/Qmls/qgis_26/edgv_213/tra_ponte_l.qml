...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="3" type="QString" name="Fixa"/>
              <Option value="1" type="QString" name="Móvel"/>
              <Option value="2" type="QString" name="Pênsil"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoponte" index="4" name=""/>
    ...
    <alias field="vaolivrevertical" index="10" name=""/>
    <alias field="cargasuportmaxima" index="11" name=""/>
    <alias field="nrfaixas" index="12" name=""/>
    <alias field="nrpistas" index="13" name=""/>
    <alias field="posicaopista" index="14" name=""/>
    <alias field="largura" index="15" name=""/>
    <alias field="extensao" index="16" name=""/>
    <alias field="lenght_otf" index="17" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoponte" constraints="1" exp_strength="0" notnull_strength="1"/>
    ...
    <constraint unique_strength="0" field="vaolivrevertical" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoponte"/>
    ...
    <constraint exp="" desc="" field="vaolivrevertical"/>
