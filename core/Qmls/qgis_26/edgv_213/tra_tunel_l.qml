...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipotunel">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="2" type="QString" name="Passagem subterrânea sob via"/>
    ...
    <field name="modaluso">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="7" type="QString" name="Dutos"/>
              <Option value="5" type="QString" name="Ferroviário"/>
              <Option value="6" type="QString" name="Metroviário"/>
  ...
  <aliases>
    ...
    <alias field="tipotunel" index="4" name=""/>
    ...
    <alias field="posicaopista" index="11" name=""/>
    <alias field="altura" index="12" name=""/>
    <alias field="extensao" index="13" name=""/>
    <alias field="lenght_otf" index="14" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipotunel" constraints="1" exp_strength="0" notnull_strength="1"/>
    ...
    <constraint unique_strength="0" field="situacaofisica" constraints="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint unique_strength="0" field="altura" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipotunel"/>
    ...
    <constraint exp="" desc="" field="altura"/>
