...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="situamare">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="7" type="QString" name="Cobre e descobre"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="8" type="QString" name="Sempre fora d´água"/>
              <Option value="9" type="QString" name="Sempre submerso"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="situacaocosta">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="11" type="QString" name="Afastado"/>
              <Option value="10" type="QString" name="Contíguo"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tiporecife" index="4" name=""/>
    <alias field="situamare" index="5" name=""/>
    <alias field="situacaocosta" index="6" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tiporecife" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="situamare" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="situacaocosta" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tiporecife"/>
    <constraint exp="" desc="" field="situamare"/>
    <constraint exp="" desc="" field="situacaocosta"/>
