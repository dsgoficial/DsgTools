...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoclassecnae">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="16" type="QString" name="80.13-6 - Educação Infantil - Creche"/>
              <Option value="17" type="QString" name="80.14-4 - Educação Infantil - Pré-Escola"/>
              <Option value="18" type="QString" name="80.15-2 - Ensino Fundamental"/>
              <Option value="19" type="QString" name="80.20-9 - Ensino Médio"/>
              <Option value="20" type="QString" name="80.31-4 - Educação Superior - Graduação"/>
              <Option value="21" type="QString" name="80.32-2 - Educação Superior - Graduação e Pós-Graduação"/>
              <Option value="22" type="QString" name="80.33-0 - Educação Superior - Pós-Graduação e Extensão"/>
              <Option value="23" type="QString" name="80.96-9 - Educação Profissional de Nível Técnico"/>
              <Option value="24" type="QString" name="80.97-7 - Educação Profissional de Nível Tecnológico"/>
              <Option value="25" type="QString" name="80.99-3 - Outras Atividades de Ensino"/>
              <Option value="0" type="QString" name="Desconhecido"/>
  ...
  <aliases>
    ...
    <alias field="id_org_ensino" index="8" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="id_org_ensino" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="id_org_ensino"/>
