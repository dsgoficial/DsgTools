...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipobanco">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="4" type="QString" name="Cordão Arenoso"/>
              <Option value="1" type="QString" name="Fluvial"/>
              <Option value="3" type="QString" name="Lacustre"/>
              <Option value="2" type="QString" name="Marítimo"/>
            </Option>
          </Option>
        </config>
      </editWidget>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="24" type="QString" name="Saibro"/>
  ...
  <aliases>
    ...
    <alias field="tipobanco" index="4" name=""/>
    <alias field="situacaoemagua" index="5" name=""/>
    <alias field="materialpredominante" index="6" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipobanco" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="situacaoemagua" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipobanco"/>
    <constraint exp="" desc="" field="situacaoemagua"/>
