...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="usoprincipal">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="2" type="QString" name="Abastecimento"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="3" type="QString" name="Energia"/>
              <Option value="1" type="QString" name="Irrigação"/>
  ...
  <aliases>
    ...
    <alias field="usoprincipal" index="4" name=""/>
    <alias field="volumeutil" index="5" name=""/>
    <alias field="namaximomaximorum" index="6" name=""/>
    <alias field="namaximooperacional" index="7" name=""/>
    <alias field="id_complexo_gerad_energ_eletr" index="8" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="usoprincipal" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="volumeutil" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="namaximomaximorum" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="namaximooperacional" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="usoprincipal"/>
    <constraint exp="" desc="" field="volumeutil"/>
    <constraint exp="" desc="" field="namaximomaximorum"/>
    <constraint exp="" desc="" field="namaximooperacional"/>
