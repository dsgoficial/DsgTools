...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="relacionado">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="2" type="QString" name="Barragem"/>
              <Option value="3" type="QString" name="Comporta"/>
              <Option value="15" type="QString" name="Confluência"/>
              <Option value="5" type="QString" name="Corredeira"/>
              <Option value="1" type="QString" name="Eclusa"/>
              <Option value="13" type="QString" name="Entre trechos de drenagem"/>
              <Option value="6" type="QString" name="Foz marítima"/>
              <Option value="17" type="QString" name="Interrupção à Jusante"/>
              <Option value="18" type="QString" name="Interrupção à Montante"/>
              <Option value="9" type="QString" name="Lago / Lagoa"/>
              <Option value="11" type="QString" name="Laguna"/>
              <Option value="8" type="QString" name="Meandro abandonado"/>
              <Option value="14" type="QString" name="Ponto início de drenagem"/>
              <Option value="4" type="QString" name="Queda d’água"/>
              <Option value="19" type="QString" name="Ramificação"/>
              <Option value="12" type="QString" name="Represa/ açude"/>
              <Option value="7" type="QString" name="Sumidouro"/>
              <Option value="16" type="QString" name="Vertedouro"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="relacionado" index="4" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="relacionado" constraints="1" exp_strength="0" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="relacionado"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
