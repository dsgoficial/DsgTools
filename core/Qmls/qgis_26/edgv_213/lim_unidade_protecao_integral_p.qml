...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipounidprotinteg">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="1" type="QString" name="Estação Ecológica - ESEC"/>
              <Option value="3" type="QString" name="Monumento batural - MONA"/>
              <Option value="2" type="QString" name="Parque - PAR"/>
              <Option value="5" type="QString" name="Refúgio de Vida Silvestre - RVS"/>
              <Option value="4" type="QString" name="Reserva Biológica - REBIO"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="areaoficial" index="5" name=""/>
    <alias field="atolegal" index="6" name=""/>
    <alias field="administracao" index="7" name=""/>
    <alias field="tipounidprotinteg" index="8" name=""/>
    <alias field="sigla" index="9" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipounidprotinteg" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipounidprotinteg"/>
