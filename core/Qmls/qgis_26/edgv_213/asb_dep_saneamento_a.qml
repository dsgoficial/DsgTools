...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipodepsaneam">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="6" type="QString" name="Aterro controlado"/>
              <Option value="5" type="QString" name="Aterro sanitário"/>
              <Option value="4" type="QString" name="Depósito de lixo"/>
    ...
    <field name="finalidade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="8" type="QString" name="Armazenamento"/>
              <Option value="0" type="QString" name="Desconhecido"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="1" type="QString" name="Líquido"/>
              <Option value="2" type="QString" name="Sólido"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tiporesiduo">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="15" type="QString" name="Chorume"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="9" type="QString" name="Esgoto"/>
              <Option value="12" type="QString" name="Lixo domiciliar e comercial"/>
              <Option value="14" type="QString" name="Lixo séptico"/>
              <Option value="13" type="QString" name="Lixo tóxico"/>
  ...
  <aliases>
    ...
    <alias field="tipodepsaneam" index="4" name=""/>
    <alias field="construcao" index="5" name=""/>
    <alias field="matconstr" index="6" name=""/>
    <alias field="finalidade" index="7" name=""/>
    <alias field="operacional" index="8" name=""/>
    <alias field="situacaofisica" index="9" name=""/>
    <alias field="residuo" index="10" name=""/>
    <alias field="tiporesiduo" index="11" name=""/>
    <alias field="id_complexo_saneamento" index="12" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipodepsaneam" constraints="1" exp_strength="0" notnull_strength="1"/>
    ...
    <constraint unique_strength="0" field="residuo" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="tiporesiduo" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="id_complexo_saneamento" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipodepsaneam"/>
    ...
    <constraint exp="" desc="" field="residuo"/>
    <constraint exp="" desc="" field="tiporesiduo"/>
    <constraint exp="" desc="" field="id_complexo_saneamento"/>
