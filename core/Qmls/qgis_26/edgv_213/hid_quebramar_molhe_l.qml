...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="2" type="QString" name="Molhe"/>
              <Option value="1" type="QString" name="Quebramar"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoquebramolhe" index="4" name=""/>
    <alias field="matconstr" index="5" name=""/>
    <alias field="situamare" index="6" name=""/>
    <alias field="operacional" index="7" name=""/>
    <alias field="situacaofisica" index="8" name=""/>
    <alias field="lenght_otf" index="9" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoquebramolhe" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoquebramolhe"/>
