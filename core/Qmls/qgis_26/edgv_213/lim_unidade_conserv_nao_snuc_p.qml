...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias field="atolegal" index="4" name=""/>
    <alias field="administracao" index="5" name=""/>
    <alias field="classificacao" index="6" name=""/>
    <alias field="anocriacao" index="7" name=""/>
    <alias field="sigla" index="8" name=""/>
    <alias field="areaoficial" index="9" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="classificacao" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="classificacao"/>
