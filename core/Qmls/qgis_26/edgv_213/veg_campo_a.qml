...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="2" type="QString" name="Limpo"/>
              <Option value="1" type="QString" name="Sujo"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="ocorrenciaem">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="5" type="QString" name="Brejo ou Pântano"/>
              <Option value="6" type="QString" name="Caatinga"/>
              <Option value="19" type="QString" name="Campinarana"/>
              <Option value="13" type="QString" name="Cerrado ou cerradão"/>
              <Option value="7" type="QString" name="Estepe"/>
              <Option value="15" type="QString" name="Floresta"/>
              <Option value="14" type="QString" name="Macega ou chavascal"/>
              <Option value="96" type="QString" name="Não Identificado"/>
              <Option value="8" type="QString" name="Pastagem"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipocampo" index="4" name=""/>
    <alias field="ocorrenciaem" index="5" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipocampo" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="ocorrenciaem" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipocampo"/>
    <constraint exp="" desc="" field="ocorrenciaem"/>
