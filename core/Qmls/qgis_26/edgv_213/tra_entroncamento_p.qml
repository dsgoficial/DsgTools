...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoentroncamento">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="1" type="QString" name="Cruzamento rodoviário"/>
              <Option value="2" type="QString" name="Círculo rodoviário"/>
              <Option value="5" type="QString" name="Entroncamento ferroviário"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="4" type="QString" name="Rótula"/>
              <Option value="3" type="QString" name="Trevo rodoviário"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoentroncamento" index="4" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoentroncamento" constraints="1" exp_strength="0" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoentroncamento"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
