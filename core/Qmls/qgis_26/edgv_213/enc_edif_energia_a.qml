...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
  ...
  <fieldConfiguration>
    ...
    <field name="tipoedifenergia">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="1" type="QString" name="Administração"/>
              <Option value="5" type="QString" name="Chaminé"/>
              <Option value="4" type="QString" name="Depósito"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="2" type="QString" name="Oficinas"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="3" type="QString" name="Segurança"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="id_subestacao_ener_eletr">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="tipoedifenergia" index="7" name=""/>
    <alias field="id_complexo_gerad_energ_eletr" index="8" name=""/>
    <alias field="id_subestacao_ener_eletr" index="9" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_subestacao_ener_eletr" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifenergia" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="id_complexo_gerad_energ_eletr" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="id_subestacao_ener_eletr" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoedifenergia"/>
    <constraint exp="" desc="" field="id_complexo_gerad_energ_eletr"/>
    <constraint exp="" desc="" field="id_subestacao_ener_eletr"/>
