...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="16" type="QString" name="Estação ferroviária de passageiros"/>
              <Option value="17" type="QString" name="Estação metroviária"/>
              <Option value="20" type="QString" name="Oficina de manutenção"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="18" type="QString" name="Terminal ferroviário de cargas"/>
              <Option value="19" type="QString" name="Terminal ferroviário de passageiros e cargas"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="funcaoedifmetroferrov" index="7" name=""/>
    <alias field="multimodal" index="8" name=""/>
    <alias field="administracao" index="9" name=""/>
    <alias field="id_estrut_apoio" index="10" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="funcaoedifmetroferrov" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="multimodal" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="administracao" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="id_estrut_apoio" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="funcaoedifmetroferrov"/>
    <constraint exp="" desc="" field="multimodal"/>
    <constraint exp="" desc="" field="administracao"/>
    <constraint exp="" desc="" field="id_estrut_apoio"/>
