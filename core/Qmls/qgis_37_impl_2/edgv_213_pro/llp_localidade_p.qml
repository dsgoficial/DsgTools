        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Aglomerado rural isolado – Núcleo" type="QString" value="5"/>
              <Option name="Aglomerado rural isolado – Povoado" type="QString" value="6"/>
              <Option name="Bairro" type="QString" value="9"/>
              <Option name="Capital estadual" type="QString" value="2"/>
              <Option name="Capital federal" type="QString" value="3"/>
              <Option name="Cidade" type="QString" value="1"/>
              <Option name="Nome local" type="QString" value="8"/>
              <Option name="Outros aglomerados rurais – Lugarejo" type="QString" value="7"/>
              <Option name="Praça" type="QString" value="10"/>
              <Option name="Vila" type="QString" value="4"/>
            </Option>
          </Option>
        </config>
      </editWidget>
