...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Brejo/pântano arbustivo" type="QString" value="302"/>
              <Option name="Brejo/pântano arbóreo" type="QString" value="301"/>
              <Option name="Caatinga" type="QString" value="801"/>
              <Option name="Campinarana" type="QString" value="501"/>
              <Option name="Campo" type="QString" value="901"/>
              <Option name="Cerrado/Cerradão arbustivo" type="QString" value="702"/>
              <Option name="Cerrado/Cerradão arbóreo" type="QString" value="701"/>
              <Option name="Cult - Anual não identificado" type="QString" value="196"/>
              <Option name="Cult - Arroz de inundação" type="QString" value="150"/>
              <Option name="Cult - Açaí cultivado" type="QString" value="118"/>
              <Option name="Cult - Banana" type="QString" value="102"/>
              <Option name="Cult - Cacau" type="QString" value="115"/>
              <Option name="Cult - Café" type="QString" value="114"/>
              <Option name="Cult - Cana de açúcar" type="QString" value="107"/>
              <Option name="Cult - Erva-mate" type="QString" value="116"/>
              <Option name="Cult - Laranja" type="QString" value="103"/>
              <Option name="Cult - Maçã" type="QString" value="151"/>
              <Option name="Cult - Palmeira" type="QString" value="117"/>
              <Option name="Cult - Pastagem cultivada" type="QString" value="124"/>
              <Option name="Cult - Perene misto" type="QString" value="195"/>
              <Option name="Cult - Perene outros" type="QString" value="198"/>
              <Option name="Cult - Pêra" type="QString" value="153"/>
              <Option name="Cult - Pêssego" type="QString" value="152"/>
              <Option name="Cult - Seringueira" type="QString" value="119"/>
              <Option name="Cult - Videira" type="QString" value="142"/>
              <Option name="Floresta" type="QString" value="601"/>
              <Option name="Mangue arbustivo" type="QString" value="202"/>
              <Option name="Mangue arbóreo" type="QString" value="201"/>
              <Option name="Ref - Não identificado" type="QString" value="1296"/>
              <Option name="Restinga" type="QString" value="401"/>
              <Option name="Terreno exposto desconhecido" type="QString" value="1000"/>
              <Option name="Vegetação de área de contato" type="QString" value="1101"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="3" field="tipo_comprovacao"/>
    <alias name="" index="4" field="tipo_insumo"/>
    <alias name="" index="5" field="observacao"/>
    <alias name="" index="6" field="data_modificacao"/>
    <alias name="" index="7" field="controle_id"/>
    <alias name="" index="8" field="ultimo_usuario"/>
