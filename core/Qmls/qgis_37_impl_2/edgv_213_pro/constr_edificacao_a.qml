...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="1">
    <rules key="{f735d720-3f4b-46de-b13a-3ba078180df8}">
      <rule label="Edificações com área >= 625m²" key="{3e8e511c-91bd-4d04-a42c-d062b1a811d1}" filter=" $area >= 625" symbol="0"/>
      <rule label="Edificações com área &lt; 625m² (Adquirir como ponto)" key="{b3c0540e-3f96-42f8-bf14-5240e96f6497}" filter=" $area &lt; 625" symbol="1"/>
      <rule scalemaxdenom="2000" label="Afastamento mínimo" scalemindenom="1" key="{74e29d82-1727-41b3-b754-e420bd9aeb8e}" symbol="2"/>
    </rules>
    <symbols>
      ...
      <symbol name="2" force_rhr="0" type="fill" alpha="1" clip_to_extent="1">
        <layer class="GeometryGenerator" enabled="1" pass="0" locked="0">
          ...
          <prop k="geometryModifier" v="buffer($geometry, 2.5)"/>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties"/>
          ...
          <symbol name="@2@0" force_rhr="0" type="fill" alpha="0.505" clip_to_extent="1">
