...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipoedifaero" name="" index="7"/>
    <alias field="administracao" name="" index="8"/>
    <alias field="id_complexo_aeroportuario" name="" index="9"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tipoedifaero" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipoedifaero" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipoedifaero" desc="" exp=""/>
