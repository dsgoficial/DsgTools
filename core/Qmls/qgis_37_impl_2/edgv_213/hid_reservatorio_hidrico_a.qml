...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="usoprincipal" name="" index="4"/>
    <alias field="volumeutil" name="" index="5"/>
    <alias field="namaximomaximorum" name="" index="6"/>
    <alias field="namaximooperacional" name="" index="7"/>
    <alias field="id_complexo_gerad_energ_eletr" name="" index="8"/>
  ...
  <defaults>
    ...
    <default field="usoprincipal" expression="" applyOnUpdate="0"/>
    <default field="volumeutil" expression="" applyOnUpdate="0"/>
    <default field="namaximomaximorum" expression="" applyOnUpdate="0"/>
    <default field="namaximooperacional" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="usoprincipal" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="volumeutil" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="namaximomaximorum" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="namaximooperacional" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="usoprincipal" desc="" exp=""/>
    <constraint field="volumeutil" desc="" exp=""/>
    <constraint field="namaximomaximorum" desc="" exp=""/>
    <constraint field="namaximooperacional" desc="" exp=""/>
