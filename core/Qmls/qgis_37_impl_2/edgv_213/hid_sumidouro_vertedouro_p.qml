...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tiposumvert" name="" index="4"/>
    <alias field="causa" name="" index="5"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tiposumvert" expression="" applyOnUpdate="0"/>
    <default field="causa" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="tiposumvert" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="causa" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="tiposumvert" desc="" exp=""/>
    <constraint field="causa" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
