...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="nometi" name="" index="4"/>
    <alias field="situacaojuridica" name="" index="5"/>
    <alias field="datasituacaojuridica" name="" index="6"/>
    <alias field="grupoetnico" name="" index="7"/>
    <alias field="areaoficialha" name="" index="8"/>
    <alias field="perimetrooficial" name="" index="9"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="nometi" expression="" applyOnUpdate="0"/>
    <default field="situacaojuridica" expression="" applyOnUpdate="0"/>
    <default field="datasituacaojuridica" expression="" applyOnUpdate="0"/>
    <default field="grupoetnico" expression="" applyOnUpdate="0"/>
    <default field="areaoficialha" expression="" applyOnUpdate="0"/>
    <default field="perimetrooficial" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="nometi" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="situacaojuridica" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="datasituacaojuridica" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="grupoetnico" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="areaoficialha" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="perimetrooficial" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="nometi" desc="" exp=""/>
    <constraint field="situacaojuridica" desc="" exp=""/>
    <constraint field="datasituacaojuridica" desc="" exp=""/>
    <constraint field="grupoetnico" desc="" exp=""/>
    <constraint field="areaoficialha" desc="" exp=""/>
    <constraint field="perimetrooficial" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
