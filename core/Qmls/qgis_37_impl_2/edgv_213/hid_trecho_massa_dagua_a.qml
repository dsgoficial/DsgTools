...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipotrechomassa" name="" index="3"/>
    <alias field="regime" name="" index="4"/>
    <alias field="salinidade" name="" index="5"/>
    <alias field="id_trecho_curso_dagua" name="" index="6"/>
  ...
  <defaults>
    ...
    <default field="tipotrechomassa" expression="" applyOnUpdate="0"/>
    <default field="regime" expression="" applyOnUpdate="0"/>
    <default field="salinidade" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipotrechomassa" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="regime" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="salinidade" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipotrechomassa" desc="" exp=""/>
    <constraint field="regime" desc="" exp=""/>
    <constraint field="salinidade" desc="" exp=""/>
