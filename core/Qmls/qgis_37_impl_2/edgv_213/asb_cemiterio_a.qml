...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipocemiterio" name="" index="4"/>
    <alias field="denominacaoassociada" name="" index="5"/>
  ...
  <defaults>
    ...
    <default field="tipocemiterio" expression="" applyOnUpdate="0"/>
    <default field="denominacaoassociada" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipocemiterio" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="denominacaoassociada" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipocemiterio" desc="" exp=""/>
    <constraint field="denominacaoassociada" desc="" exp=""/>
