...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipoedifenergia" name="" index="7"/>
    <alias field="id_complexo_gerad_energ_eletr" name="" index="8"/>
    <alias field="id_subestacao_ener_eletr" name="" index="9"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tipoedifenergia" expression="" applyOnUpdate="0"/>
    <default field="id_complexo_gerad_energ_eletr" expression="" applyOnUpdate="0"/>
    <default field="id_subestacao_ener_eletr" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="tipoedifenergia" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="id_complexo_gerad_energ_eletr" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="id_subestacao_ener_eletr" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="tipoedifenergia" desc="" exp=""/>
    <constraint field="id_complexo_gerad_energ_eletr" desc="" exp=""/>
    <constraint field="id_subestacao_ener_eletr" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
