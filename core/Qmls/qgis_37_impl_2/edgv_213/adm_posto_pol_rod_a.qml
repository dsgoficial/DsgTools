...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipopostopol" name="" index="3"/>
    <alias field="geometriaaproximada" name="" index="4"/>
    <alias field="operacional" name="" index="5"/>
    <alias field="situacaofisica" name="" index="6"/>
    <alias field="id_org_pub_militar" name="" index="7"/>
    <alias field="id_org_pub_civil" name="" index="8"/>
  ...
  <defaults>
    ...
    <default field="tipopostopol" expression="" applyOnUpdate="0"/>
    ...
    <default field="id_org_pub_militar" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipopostopol" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    ...
    <constraint field="id_org_pub_militar" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipopostopol" desc="" exp=""/>
    ...
    <constraint field="id_org_pub_militar" desc="" exp=""/>
