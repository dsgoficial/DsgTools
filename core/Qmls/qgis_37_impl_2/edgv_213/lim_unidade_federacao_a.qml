...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="4" name="AM"/>
              <Option type="QString" value="3" name="AP"/>
              ...
              <Option type="QString" value="13" name="MG"/>
              <Option type="QString" value="12" name="MS"/>
              <Option type="QString" value="11" name="MT"/>
              <Option type="QString" value="14" name="PA"/>
              <Option type="QString" value="15" name="PB"/>
              <Option type="QString" value="17" name="PE"/>
              <Option type="QString" value="18" name="PI"/>
              <Option type="QString" value="16" name="PR"/>
              <Option type="QString" value="19" name="RJ"/>
              <Option type="QString" value="20" name="RN"/>
              <Option type="QString" value="22" name="RO"/>
              <Option type="QString" value="23" name="RR"/>
              <Option type="QString" value="21" name="RS"/>
              <Option type="QString" value="24" name="SC"/>
              <Option type="QString" value="26" name="SE"/>
              <Option type="QString" value="25" name="SP"/>
  ...
  <aliases>
    ...
    <alias field="sigla" name="" index="4"/>
    <alias field="geocodigo" name="" index="5"/>
    <alias field="area_otf" name="" index="6"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="geocodigo" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="sigla" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="geocodigo" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
