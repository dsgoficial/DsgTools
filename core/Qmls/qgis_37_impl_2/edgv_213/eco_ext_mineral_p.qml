...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="44" name="Piçarra"/>
              <Option type="QString" value="39" name="Prata"/>
              <Option type="QString" value="43" name="Saibro"/>
  ...
  <aliases>
    ...
    <alias field="tiposecaocnae" name="" index="4"/>
    <alias field="operacional" name="" index="5"/>
    <alias field="situacaofisica" name="" index="6"/>
    <alias field="tipoextmin" name="" index="7"/>
    <alias field="tipoprodutoresiduo" name="" index="8"/>
    <alias field="tipopocomina" name="" index="9"/>
    <alias field="procextracao" name="" index="10"/>
    <alias field="formaextracao" name="" index="11"/>
    <alias field="atividade" name="" index="12"/>
    <alias field="id_org_ext_mineral" name="" index="13"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tiposecaocnae" expression="" applyOnUpdate="0"/>
    <default field="operacional" expression="" applyOnUpdate="0"/>
    <default field="situacaofisica" expression="" applyOnUpdate="0"/>
    <default field="tipoextmin" expression="" applyOnUpdate="0"/>
    <default field="tipoprodutoresiduo" expression="" applyOnUpdate="0"/>
    <default field="tipopocomina" expression="" applyOnUpdate="0"/>
    <default field="procextracao" expression="" applyOnUpdate="0"/>
    <default field="formaextracao" expression="" applyOnUpdate="0"/>
    <default field="atividade" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tiposecaocnae" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    ...
    <constraint field="tipoextmin" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="tipoprodutoresiduo" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="tipopocomina" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="procextracao" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="formaextracao" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="atividade" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tiposecaocnae" desc="" exp=""/>
    <constraint field="operacional" desc="" exp=""/>
    <constraint field="situacaofisica" desc="" exp=""/>
    <constraint field="tipoextmin" desc="" exp=""/>
    <constraint field="tipoprodutoresiduo" desc="" exp=""/>
    <constraint field="tipopocomina" desc="" exp=""/>
    <constraint field="procextracao" desc="" exp=""/>
    <constraint field="formaextracao" desc="" exp=""/>
    <constraint field="atividade" desc="" exp=""/>
