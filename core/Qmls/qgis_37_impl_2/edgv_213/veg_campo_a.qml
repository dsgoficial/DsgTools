...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipocampo" name="" index="4"/>
    <alias field="ocorrenciaem" name="" index="5"/>
  ...
  <defaults>
    ...
    <default field="tipocampo" expression="" applyOnUpdate="0"/>
    <default field="ocorrenciaem" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipocampo" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="ocorrenciaem" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipocampo" desc="" exp=""/>
    <constraint field="ocorrenciaem" desc="" exp=""/>
