...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipoedifrelig" name="" index="7"/>
    <alias field="ensino" name="" index="8"/>
    <alias field="religiao" name="" index="9"/>
    <alias field="id_org_religiosa" name="" index="10"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tipoedifrelig" expression="" applyOnUpdate="0"/>
    <default field="ensino" expression="" applyOnUpdate="0"/>
    <default field="religiao" expression="" applyOnUpdate="0"/>
    <default field="id_org_religiosa" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="tipoedifrelig" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="ensino" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="religiao" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="id_org_religiosa" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="tipoedifrelig" desc="" exp=""/>
    <constraint field="ensino" desc="" exp=""/>
    <constraint field="religiao" desc="" exp=""/>
    <constraint field="id_org_religiosa" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
