...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Passagem subterrânea" type="QString" value="7"/>
              <Option name="Passarela" type="QString" value="8"/>
              <Option name="Pinguela" type="QString" value="9"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipotravessiaped" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipotravessiaped" desc=""/>
