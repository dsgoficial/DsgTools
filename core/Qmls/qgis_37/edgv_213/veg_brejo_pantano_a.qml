...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipobrejopantano">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Brejo" type="QString" value="1"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Pântano" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="6" field="tipobrejopantano"/>
    <alias name="" index="7" field="alturamediaindividuos"/>
    <alias name="" index="8" field="classificacaoporte"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipobrejopantano" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipobrejopantano" desc=""/>
