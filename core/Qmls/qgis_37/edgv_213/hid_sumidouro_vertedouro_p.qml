...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tiposumvert">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Sumidouro" type="QString" value="1"/>
              <Option name="Vertedouro" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="causa">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Absorção" type="QString" value="3"/>
              <Option name="Canalização" type="QString" value="1"/>
              <Option name="Desconhecida" type="QString" value="0"/>
              <Option name="Gruta ou Fenda" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tiposumvert"/>
    <alias name="" index="5" field="causa"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tiposumvert" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="causa" constraints="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="tiposumvert" desc=""/>
    <constraint exp="" field="causa" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
