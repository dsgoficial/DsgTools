    ...
    <field name="relacionado">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Depósito geral" type="QString" value="4"/>
              <Option name="Interrupção com a Moldura" type="QString" value="17"/>
              <Option name="Local crítico" type="QString" value="3"/>
              <Option name="Ponto de ramificação" type="QString" value="5"/>
              <Option name="Ponto final" type="QString" value="2"/>
              <Option name="Ponto inicial" type="QString" value="1"/>
            </Option>
          </Option>
        </config>
      </editWidget>
