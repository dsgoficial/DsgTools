...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoediflazer">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Anfiteatro" type="QString" value="5"/>
              <Option name="Centro cultural" type="QString" value="7"/>
              <Option name="Cinema" type="QString" value="6"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Estádio" type="QString" value="1"/>
              <Option name="Ginásio" type="QString" value="2"/>
              <Option name="Museu" type="QString" value="3"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Plataforma de pesca" type="QString" value="8"/>
              <Option name="Teatro" type="QString" value="4"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoediflazer"/>
    <alias name="" index="8" field="id_complexo_lazer"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoediflazer" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoediflazer" desc=""/>
