...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoedifturist">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Cruzeiro" type="QString" value="9"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Estátua" type="QString" value="10"/>
              <Option name="Mirante" type="QString" value="11"/>
              <Option name="Monumento" type="QString" value="12"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Panteão" type="QString" value="13"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifturist"/>
    <alias name="" index="8" field="ovgd"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifturist" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifturist" desc=""/>
