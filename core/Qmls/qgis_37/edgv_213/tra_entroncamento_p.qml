...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoentroncamento">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Cruzamento rodoviário" type="QString" value="1"/>
              <Option name="Círculo rodoviário" type="QString" value="2"/>
              <Option name="Entroncamento ferroviário" type="QString" value="5"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Rótula" type="QString" value="4"/>
              <Option name="Trevo rodoviário" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipoentroncamento"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoentroncamento" constraints="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoentroncamento" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
