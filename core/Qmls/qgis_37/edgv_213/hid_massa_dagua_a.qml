...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Lago/Lagoa" type="QString" value="7"/>
              <Option name="Meandro Abandonado" type="QString" value="6"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Desconhecida" type="QString" value="0"/>
              <Option name="Doce" type="QString" value="1"/>
              <Option name="Salgada" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipomassadagua" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="regime" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="salinidade" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipomassadagua" desc=""/>
    <constraint exp="" field="regime" desc=""/>
    <constraint exp="" field="salinidade" desc=""/>
