...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="3" field="situacaoemagua"/>
    <alias name="" index="4" field="alturalamina"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="alturalamina" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="alturalamina" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
