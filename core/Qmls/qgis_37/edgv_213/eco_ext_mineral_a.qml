...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tiposecaocnae">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="C - Indústrias Extrativas" type="QString" value="1"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Ponto de Prospecção" type="QString" value="8"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Piçarra" type="QString" value="44"/>
              <Option name="Prata" type="QString" value="39"/>
              <Option name="Saibro" type="QString" value="43"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Horizontal" type="QString" value="2"/>
              <Option name="Não aplicável" type="QString" value="97"/>
              <Option name="Vertical" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Manual" type="QString" value="2"/>
              <Option name="Mecanizado" type="QString" value="1"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Produção" type="QString" value="10"/>
              <Option name="Prospecção" type="QString" value="9"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tiposecaocnae"/>
    <alias name="" index="5" field="operacional"/>
    <alias name="" index="6" field="situacaofisica"/>
    <alias name="" index="7" field="tipoextmin"/>
    <alias name="" index="8" field="tipoprodutoresiduo"/>
    <alias name="" index="9" field="tipopocomina"/>
    <alias name="" index="10" field="procextracao"/>
    <alias name="" index="11" field="formaextracao"/>
    <alias name="" index="12" field="atividade"/>
    <alias name="" index="13" field="id_org_ext_mineral"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tiposecaocnae" constraints="1" exp_strength="0"/>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoextmin" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="tipoprodutoresiduo" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="tipopocomina" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="procextracao" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="formaextracao" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="atividade" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tiposecaocnae" desc=""/>
    <constraint exp="" field="operacional" desc=""/>
    <constraint exp="" field="situacaofisica" desc=""/>
    <constraint exp="" field="tipoextmin" desc=""/>
    <constraint exp="" field="tipoprodutoresiduo" desc=""/>
    <constraint exp="" field="tipopocomina" desc=""/>
    <constraint exp="" field="procextracao" desc=""/>
    <constraint exp="" field="formaextracao" desc=""/>
    <constraint exp="" field="atividade" desc=""/>
