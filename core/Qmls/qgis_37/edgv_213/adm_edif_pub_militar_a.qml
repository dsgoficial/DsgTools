...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoedifmil">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Aquartelamento" type="QString" value="12"/>
              <Option name="Base aérea" type="QString" value="15"/>
              <Option name="Campo de instrução" type="QString" value="13"/>
              <Option name="Campo de tiro" type="QString" value="14"/>
              <Option name="Delegacia serviço militar" type="QString" value="18"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Distrito naval" type="QString" value="16"/>
              <Option name="Hotel de trânsito" type="QString" value="17"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Posto" type="QString" value="19"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifmil"/>
    <alias name="" index="8" field="tipousoedif"/>
    <alias name="" index="9" field="id_org_pub_militar"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifmil" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="tipousoedif" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_org_pub_militar" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifmil" desc=""/>
    <constraint exp="" field="tipousoedif" desc=""/>
    <constraint exp="" field="id_org_pub_militar" desc=""/>
