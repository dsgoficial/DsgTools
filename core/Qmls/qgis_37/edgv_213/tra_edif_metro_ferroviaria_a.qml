...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="funcaoedifmetroferrov">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Administrativa" type="QString" value="15"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Estação ferroviária de passageiros" type="QString" value="16"/>
              <Option name="Estação metroviária" type="QString" value="17"/>
              <Option name="Oficina de manutenção" type="QString" value="20"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Terminal ferroviário de cargas" type="QString" value="18"/>
              <Option name="Terminal ferroviário de passageiros e cargas" type="QString" value="19"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="funcaoedifmetroferrov"/>
    <alias name="" index="8" field="multimodal"/>
    <alias name="" index="9" field="administracao"/>
    <alias name="" index="10" field="id_estrut_apoio"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="funcaoedifmetroferrov" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="multimodal" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="administracao" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_estrut_apoio" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="funcaoedifmetroferrov" desc=""/>
    <constraint exp="" field="multimodal" desc=""/>
    <constraint exp="" field="administracao" desc=""/>
    <constraint exp="" field="id_estrut_apoio" desc=""/>
