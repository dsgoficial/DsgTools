    ...
    <field name="relacionado">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Atracadouro" type="QString" value="24"/>
              <Option name="Barragem" type="QString" value="19"/>
              <Option name="Complexo portuário" type="QString" value="22"/>
              <Option name="Confluência" type="QString" value="21"/>
              <Option name="Corredeira" type="QString" value="13"/>
              <Option name="Eclusa" type="QString" value="14"/>
              <Option name="Entre trechos hidroviários" type="QString" value="23"/>
              <Option name="Foz marítima" type="QString" value="16"/>
              <Option name="Interrupção com a Moldura" type="QString" value="17"/>
              <Option name="Queda dágua" type="QString" value="12"/>
            </Option>
          </Option>
        </config>
      </editWidget>
