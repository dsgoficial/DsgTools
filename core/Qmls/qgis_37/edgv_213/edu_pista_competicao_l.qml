    ...
    <field name="tipopista">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Atletismo" type="QString" value="1"/>
              <Option name="Automobilismo" type="QString" value="4"/>
              <Option name="Ciclismo" type="QString" value="2"/>
              <Option name="Corrida de cavalos" type="QString" value="5"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Misto" type="QString" value="98"/>
              <Option name="Motociclismo" type="QString" value="3"/>
