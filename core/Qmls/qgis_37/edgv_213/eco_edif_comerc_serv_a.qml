...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoedifcomercserv">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Centro comercial" type="QString" value="3"/>
              <Option name="Centro de convenções" type="QString" value="5"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Feira" type="QString" value="6"/>
              <Option name="Hotel/motel/pousada" type="QString" value="7"/>
              <Option name="Mercado" type="QString" value="4"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Restaurante" type="QString" value="8"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="finalidade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Comercial" type="QString" value="1"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Mista" type="QString" value="98"/>
              <Option name="Serviço" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifcomercserv"/>
    <alias name="" index="8" field="finalidade"/>
    <alias name="" index="9" field="id_org_comerc_serv"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifcomercserv" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifcomercserv" desc=""/>
