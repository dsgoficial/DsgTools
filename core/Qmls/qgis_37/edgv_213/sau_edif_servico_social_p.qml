...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoclassecnae">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="85.31-6 - Serviços Sociais com alojamento" type="QString" value="32"/>
              <Option name="85.32-4 - Serviços Sociais sem alojamento" type="QString" value="33"/>
              <Option name="Desconhecido" type="QString" value="0"/>
  ...
  <aliases>
    ...
    <alias name="" index="8" field="id_org_servico_social"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="id_org_servico_social" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="id_org_servico_social" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
