...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipolimmassa">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Costa visível da carta" type="QString" value="1"/>
              <Option name="Limite com elemento artificial" type="QString" value="6"/>
              <Option name="Limite interno com foz marítima" type="QString" value="7"/>
              <Option name="Limite interno entre massas e/ou trechos" type="QString" value="5"/>
              <Option name="Margem de massa d`água" type="QString" value="2"/>
              <Option name="Margem direita de trechos de massa d`água" type="QString" value="4"/>
              <Option name="Margem esquerda de trechos de massa d`água" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="materialpredominante">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Areia" type="QString" value="12"/>
              <Option name="Areia Fina" type="QString" value="13"/>
              <Option name="Argila" type="QString" value="15"/>
              <Option name="Cascalho" type="QString" value="18"/>
              <Option name="Concha" type="QString" value="21"/>
              <Option name="Coral" type="QString" value="20"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Lama" type="QString" value="14"/>
              <Option name="Lodo" type="QString" value="16"/>
              <Option name="Misto" type="QString" value="98"/>
              <Option name="Não Aplicável" type="QString" value="97"/>
              <Option name="Pedra" type="QString" value="50"/>
              <Option name="Rocha" type="QString" value="4"/>
              <Option name="Seixo" type="QString" value="19"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="tipolimmassa"/>
    <alias name="" index="3" field="materialpredominante"/>
    <alias name="" index="4" field="alturamediamargem"/>
    <alias name="" index="5" field="nomeabrev"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipolimmassa" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="materialpredominante" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="alturamediamargem" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipolimmassa" desc=""/>
    <constraint exp="" field="materialpredominante" desc=""/>
    <constraint exp="" field="alturamediamargem" desc=""/>
