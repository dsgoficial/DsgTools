...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoedifrelig">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Centro" type="QString" value="3"/>
              <Option name="Convento" type="QString" value="5"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Igreja" type="QString" value="1"/>
              <Option name="Mesquita" type="QString" value="6"/>
              <Option name="Mosteiro" type="QString" value="4"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Sinagoga" type="QString" value="7"/>
              <Option name="Templo" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifrelig"/>
    <alias name="" index="8" field="ensino"/>
    <alias name="" index="9" field="religiao"/>
    <alias name="" index="10" field="id_org_religiosa"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifrelig" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="ensino" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="religiao" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_org_religiosa" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifrelig" desc=""/>
    <constraint exp="" field="ensino" desc=""/>
    <constraint exp="" field="religiao" desc=""/>
    <constraint exp="" field="id_org_religiosa" desc=""/>
