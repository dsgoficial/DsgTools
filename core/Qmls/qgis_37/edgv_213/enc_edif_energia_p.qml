...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoedifenergia">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Administração" type="QString" value="1"/>
              <Option name="Chaminé" type="QString" value="5"/>
              <Option name="Depósito" type="QString" value="4"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Oficinas" type="QString" value="2"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Segurança" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifenergia"/>
    <alias name="" index="8" field="id_complexo_gerad_energ_eletr"/>
    <alias name="" index="9" field="id_subestacao_ener_eletr"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifenergia" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_complexo_gerad_energ_eletr" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_subestacao_ener_eletr" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifenergia" desc=""/>
    <constraint exp="" field="id_complexo_gerad_energ_eletr" desc=""/>
    <constraint exp="" field="id_subestacao_ener_eletr" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
