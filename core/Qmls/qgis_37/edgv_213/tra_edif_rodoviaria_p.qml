...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Parada interestadual" type="QString" value="10"/>
              <Option name="Posto de fiscalização" type="QString" value="14"/>
              <Option name="Posto de pedágio" type="QString" value="13"/>
              <Option name="Posto de pesagem" type="QString" value="12"/>
              <Option name="Terminal interestadual" type="QString" value="8"/>
              <Option name="Terminal urbano" type="QString" value="9"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifrod"/>
    <alias name="" index="8" field="administracao"/>
    <alias name="" index="9" field="id_estrut_apoio"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifrod" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifrod" desc=""/>
