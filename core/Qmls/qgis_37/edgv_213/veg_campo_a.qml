...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Limpo" type="QString" value="2"/>
              <Option name="Sujo" type="QString" value="1"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="ocorrenciaem">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Brejo ou Pântano" type="QString" value="5"/>
              <Option name="Caatinga" type="QString" value="6"/>
              <Option name="Campinarana" type="QString" value="19"/>
              <Option name="Cerrado ou cerradão" type="QString" value="13"/>
              <Option name="Estepe" type="QString" value="7"/>
              <Option name="Floresta" type="QString" value="15"/>
              <Option name="Macega ou chavascal" type="QString" value="14"/>
              <Option name="Não Identificado" type="QString" value="96"/>
              <Option name="Pastagem" type="QString" value="8"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipocampo"/>
    <alias name="" index="5" field="ocorrenciaem"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipocampo" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="ocorrenciaem" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipocampo" desc=""/>
    <constraint exp="" field="ocorrenciaem" desc=""/>
