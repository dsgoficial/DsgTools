...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="usoprincipal">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Abastecimento" type="QString" value="2"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Energia" type="QString" value="3"/>
              <Option name="Irrigação" type="QString" value="1"/>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="usoprincipal"/>
    <alias name="" index="5" field="volumeutil"/>
    <alias name="" index="6" field="namaximomaximorum"/>
    <alias name="" index="7" field="namaximooperacional"/>
    <alias name="" index="8" field="id_complexo_gerad_energ_eletr"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="usoprincipal" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="volumeutil" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="namaximomaximorum" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="namaximooperacional" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="usoprincipal" desc=""/>
    <constraint exp="" field="volumeutil" desc=""/>
    <constraint exp="" field="namaximomaximorum" desc=""/>
    <constraint exp="" field="namaximooperacional" desc=""/>
