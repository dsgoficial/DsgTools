...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Sempre fora d´água" type="QString" value="8"/>
              <Option name="Sempre submerso" type="QString" value="9"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="situacaocosta">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Afastado" type="QString" value="11"/>
              <Option name="Contíguo" type="QString" value="10"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tiporecife"/>
    <alias name="" index="5" field="situamare"/>
    <alias name="" index="6" field="situacaocosta"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tiporecife" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="situamare" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="situacaocosta" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tiporecife" desc=""/>
    <constraint exp="" field="situamare" desc=""/>
    <constraint exp="" field="situacaocosta" desc=""/>
