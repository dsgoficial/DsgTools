...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Pedregoso" type="QString" value="4"/>
    ...
    <field name="causaexposicao">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Artificial" type="QString" value="5"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Natural" type="QString" value="4"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="tipoterrexp"/>
    <alias name="" index="3" field="causaexposicao"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoterrexp" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="causaexposicao" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoterrexp" desc=""/>
    <constraint exp="" field="causaexposicao" desc=""/>
