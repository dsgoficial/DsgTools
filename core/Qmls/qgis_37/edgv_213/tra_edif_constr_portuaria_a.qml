...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Carreira" type="QString" value="36"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Dique de estaleiro" type="QString" value="34"/>
              <Option name="Estaleiro" type="QString" value="33"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Rampa" type="QString" value="35"/>
              <Option name="Terminal de cargas" type="QString" value="27"/>
              <Option name="Terminal de passageiros" type="QString" value="26"/>
              <Option name="Terminal privativo" type="QString" value="37"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifport"/>
    <alias name="" index="8" field="administracao"/>
    <alias name="" index="9" field="id_complexo_portuario"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifport" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="administracao" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_complexo_portuario" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifport" desc=""/>
    <constraint exp="" field="administracao" desc=""/>
    <constraint exp="" field="id_complexo_portuario" desc=""/>
