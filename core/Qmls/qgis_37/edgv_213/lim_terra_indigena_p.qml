...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="situacaojuridica">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Declarada" type="QString" value="2"/>
              <Option name="Delimitada" type="QString" value="1"/>
              <Option name="Desconhecida" type="QString" value="0"/>
              <Option name="Homologada ou demarcada" type="QString" value="3"/>
              <Option name="Regularizada" type="QString" value="4"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="nometi"/>
    <alias name="" index="5" field="situacaojuridica"/>
    <alias name="" index="6" field="datasituacaojuridica"/>
    <alias name="" index="7" field="grupoetnico"/>
    <alias name="" index="8" field="areaoficialha"/>
    <alias name="" index="9" field="perimetrooficial"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="nometi" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="situacaojuridica" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="datasituacaojuridica" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="grupoetnico" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="areaoficialha" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="perimetrooficial" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="nometi" desc=""/>
    <constraint exp="" field="situacaojuridica" desc=""/>
    <constraint exp="" field="datasituacaojuridica" desc=""/>
    <constraint exp="" field="grupoetnico" desc=""/>
    <constraint exp="" field="areaoficialha" desc=""/>
    <constraint exp="" field="perimetrooficial" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
