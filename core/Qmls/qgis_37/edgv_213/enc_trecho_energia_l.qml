...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Distribuição" type="QString" value="3"/>
              <Option name="Transmissão" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="especie"/>
    <alias name="" index="5" field="posicaorelativa"/>
    <alias name="" index="6" field="operacional"/>
    <alias name="" index="7" field="situacaofisica"/>
    <alias name="" index="8" field="emduto"/>
    <alias name="" index="9" field="tensaoeletrica"/>
    <alias name="" index="10" field="numcircuitos"/>
    <alias name="" index="11" field="id_org_comerc_serv"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="especie" constraints="1" exp_strength="0"/>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="emduto" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="tensaoeletrica" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="numcircuitos" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="especie" desc=""/>
    <constraint exp="" field="posicaorelativa" desc=""/>
    <constraint exp="" field="operacional" desc=""/>
    <constraint exp="" field="situacaofisica" desc=""/>
    <constraint exp="" field="emduto" desc=""/>
    <constraint exp="" field="tensaoeletrica" desc=""/>
    <constraint exp="" field="numcircuitos" desc=""/>
