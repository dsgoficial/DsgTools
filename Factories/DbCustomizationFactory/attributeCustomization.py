...
class AttributeCustomization(DbCustomization):
    ...
    def buildSql(self):
        ...
        attrDef = [{'attrName':'nome', 'attrType':'varchar(80)', 'isPk':False, 'isNullable':True, 'references':None, 'defaultValue':None, 'filter':[], childrenToAlter:[-list of children-]}]
        '''
        ...
        for modItem in self.customJson['AttributeToAdd']:
            ...
            for attr in modItem['attrList']:
                ...
                if len(attr['filter']) > 0:
                    ...
                    for child in attr['childrenToAlter']:
