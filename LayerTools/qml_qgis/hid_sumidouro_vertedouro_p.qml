...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="1" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="3" name="causa">
      <valuepair key="Canalização" value="1"/>
      <valuepair key="Gruta ou Fenda" value="2"/>
      <valuepair key="Absorção" value="3"/>
      <valuepair key="Desconhecida" value="0"/>
    </edittype>
    <edittype labelontop="0" editable="1" type="3" name="tiposumvert">
      <valuepair key="Sumidouro" value="1"/>
      <valuepair key="Vertedouro" value="2"/>
    </edittype>
  </edittypes>
</qgis>