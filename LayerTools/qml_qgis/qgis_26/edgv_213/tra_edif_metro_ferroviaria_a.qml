<!DOCTYPE qgis PUBLIC 'http://mrcc.com/qgis.dtd' 'SYSTEM'><qgis version="2.6.0-Brighton" minimumScale="1" maximumScale="1" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="geometriaaproximada">
    ...
    </edittype>    <edittype widgetv2type="ValueMap" name="funcaoedifmetroferrov">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Desconhecido" value="0"/>
        <value key="Estação ferroviária de passageiros" value="16"/>
        <value key="Estação metroviária" value="17"/>
        <value key="Terminal ferroviário de cargas" value="18"/>
        <value key="Terminal ferroviário de passageiros e cargas" value="19"/>
        <value key="Administrativa" value="15"/>
        <value key="Oficina de manutenção" value="20"/>
        <value key="Outros" value="99"/>
      </widgetv2config>
    </edittype>    <edittype widgetv2type="ValueMap" name="multimodal">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Sim" value="1"/>
        <value key="Desconhecido" value="0"/>
        <value key="Não" value="2"/>
      ...
      <widgetv2config fieldEditable="1" labelOnTop="0">
        ...
        <value key="Terminal ferroviário de cargas" value="18"/>
        <value key="Terminal ferroviário de passageiros e cargas" value="19"/>
        <value key="Oficina de manuntenção" value="20"/>
