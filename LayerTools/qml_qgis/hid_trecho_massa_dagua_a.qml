...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="1" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="tipotrechomassa = 1 and regime = 1 and salinidade = 1" symbol="0" label="Rio, Permanente, Doce"/>
      <rule filter="not(tipotrechomassa = 1 and regime = 1 and salinidade = 1)" symbol="1" label="Outro"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color_border" v="64,101,235,255"/>
          <prop k="offset" v="0,0"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="3" name="tipotrechomassa">
