...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="1" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="3" name="tipoentroncamento">
      <valuepair key="Cruzamento rodoviário" value="1"/>
      <valuepair key="Círculo rodoviário" value="2"/>
      <valuepair key="Trevo rodoviário" value="3"/>
      <valuepair key="Rótula" value="4"/>
      <valuepair key="Entroncamento ferroviário" value="5"/>
