...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="1" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="3" name="tipoalterantrop">
      <valuepair key="Desconhecido" value="0"/>
      <valuepair key="Resíduo de bota-fora" value="28"/>
      <valuepair key="Resíduo sólido em geral" value="29"/>
      <valuepair key="Caixa de empréstimo" value="24"/>
      <valuepair key="Área aterrada" value="25"/>
      <valuepair key="Corte" value="26"/>
      <valuepair key="Aterro" value="27"/>
    </edittype>
  </edittypes>
</qgis>