...
<qgis version="2.2.0-Valmiera" minimumScale="1" maximumScale="1" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="3" name="qualidagua">
      <valuepair key="Potável" value="1"/>
      <valuepair key="Não potável" value="2"/>
      <valuepair key="Mineral" value="3"/>
      <valuepair key="Salobra" value="4"/>
      <valuepair key="Desconhecida" value="0"/>
    </edittype>
    <edittype labelontop="0" editable="1" type="3" name="tipofontedagua">
      <valuepair key="Poço" value="1"/>
      <valuepair key="Poço Artesiano" value="2"/>
      <valuepair key="Olho d`água" value="3"/>
      <valuepair key="Desconhecido" value="0"/>
    </edittype>
  </edittypes>
</qgis>