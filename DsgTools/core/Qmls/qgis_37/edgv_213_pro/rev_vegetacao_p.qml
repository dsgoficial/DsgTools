...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{79bf2d05-07e2-4dd4-95f8-23bfa0ea6b68}">
      <rule label="1" key="{9e370ded-5cb9-4a12-869b-82d2fd70565a}" filter=" &quot;corrigido&quot; =  1 " symbol="0">
        <rule label="obsoperador" key="{c9a85d87-48f7-48b4-8bef-e756c533e262}" filter="length(&quot;obsoperador&quot;) != 0  AND  &quot;obsoperador&quot; IS NOT NULL" symbol="1"/>
      </rule>
      <rule key="{21c96a0f-37b6-4f6d-8e62-4b99aad453b3}" filter="ELSE" symbol="2"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{13f850c1-d8d9-49e9-a146-a1b7d6579f06}">
      <rule key="{dc897f66-cea2-4e6a-9099-150e3917a72d}" filter=" &quot;corrigido&quot; = 1">
        <settings calloutType="simple">
          <text-style fontSize="14" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontWordSpacing="0" textColor="0,0,0,255" fontFamily="Noto Sans" fontLetterSpacing="0" blendMode="0" fontItalic="0" namedStyle="Normal" fontUnderline="0" isExpression="1" textOpacity="1" multilineHeight="1" fontCapitals="0" fieldName="''" fontWeight="50">
            <text-buffer bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferOpacity="1" bufferDraw="1" bufferBlendMode="0" bufferColor="255,255,1,255" bufferJoinStyle="128" bufferNoFill="1"/>
          ...
          <text-format placeDirectionSymbol="0" multilineAlign="3" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" addDirectionSymbol="0" reverseDirectionSymbol="0" formatNumbers="0" wrapChar="" decimals="3" plussign="0" autoWrapLength="0" useMaxLineLengthForAutoWrap="1"/>
          <placement distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" distUnits="MM" preserveRotation="1" centroidWhole="0" fitInPolygonOnly="0" layerType="UnknownGeometry" rotationAngle="0" offsetType="0" quadOffset="4" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" xOffset="0" maxCurvedCharAngleIn="25" placement="0" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" placementFlags="10" repeatDistance="0" dist="0" offsetUnits="MM" yOffset="0" priority="5" repeatDistanceUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <rule key="{2a8eb10f-6749-464f-98db-b7daffea86d6}" filter="ELSE">
        <settings calloutType="simple">
          <text-style fontSize="14" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontWordSpacing="0" textColor="0,0,0,255" fontFamily="Noto Sans" fontLetterSpacing="0" blendMode="0" fontItalic="0" namedStyle="Normal" fontUnderline="0" isExpression="0" textOpacity="1" multilineHeight="1" fontCapitals="0" fieldName="obs" fontWeight="50">
            <text-buffer bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferOpacity="1" bufferDraw="1" bufferBlendMode="0" bufferColor="247,255,1,255" bufferJoinStyle="128" bufferNoFill="1"/>
            <background shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="Point" shapeOffsetX="0" shapeBlendMode="0" shapeSVGFile="" shapeDraw="0" shapeRotation="0" shapeOpacity="1" shapeOffsetY="0" shapeType="0" shapeRotationType="0" shapeBorderColor="128,128,128,255" shapeSizeType="0" shapeSizeX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeRadiiY="0" shapeRadiiX="0" shapeOffsetUnit="Point" shapeFillColor="255,255,255,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeSizeUnit="Point" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeBorderWidthUnit="Point"/>
            <shadow shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusAlphaOnly="0" shadowOffsetDist="1" shadowOffsetUnit="MM" shadowScale="100" shadowColor="0,0,0,255" shadowOffsetAngle="135" shadowUnder="0" shadowDraw="0" shadowRadius="1.5" shadowOffsetGlobal="1" shadowRadiusUnit="MM" shadowOpacity="0.7" shadowBlendMode="6"/>
            <dd_properties>
              <Option type="Map">
  ...
  <customproperties>
    ...
    <property key="variableValues">
      <value>2720-2_5_3</value>
      <value>SRID=31981;POLYGON((645678.269524183 7506525.64926762,641393.023003543 7506565.67832637,641435.434526805 7511178.83754259,645721.967319141 7511138.86663348,645678.269524183 7506525.64926762))</value>
      <value>{"uiData": {"layer_data": {"layer_schema": "edgv", "layer_name": "rev_vegetacao_p", "layer_geom_type": "MULTIPOINT", "layer_fields": {"corrigido": {"valueMap": {"Sim": 1, "Não": 2, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "ultimo_usuario": {}, "controle_id": {}, "tipo_comprovacao": {"valueMap": {"Confirmado em campo": 1, "Não possível de confirmar em campo": 2, "Feição não necessita de confirmação": 3, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "obs": {}, "observacao": {}, "data_modificacao": {}, "categoria": {}, "tipo_insumo": {"valueMap": {"Fotointerpretado": 1, "Insumo externo": 2, "Processo automático": 3, "Aquisição em campo": 4, "Mapeamento anterior": 5, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}}, "group_geom": "PONTO", "group_class": "rev"}, "fields_sorted": ["corrigido", "ultimo_usuario", "controle_id", "tipo_comprovacao", "obs", "observacao", "data_modificacao", "categoria", "tipo_insumo"], "form_name": "C:/Users/proc/AppData/Roaming/QGIS/QGIS3\\profiles\\default/python/plugins\\Ferramentas_Producao\\Tools\\LoadData\\forms\\sisfron_sirgas2000_utm_21S_rev_vegetacao_p.ui"}}</value>
    </property>
  </customproperties>
  ...
  <aliases>
    ...
    <alias name="obs" index="1" field="obs"/>
    <alias name="categoria" index="2" field="categoria"/>
    <alias name="corrigido" index="3" field="corrigido"/>
    <alias name="tipo_comprovacao" index="4" field="tipo_comprovacao"/>
    <alias name="tipo_insumo" index="5" field="tipo_insumo"/>
    <alias name="observacao" index="6" field="observacao"/>
    <alias name="data_modificacao" index="7" field="data_modificacao"/>
    <alias name="controle_id" index="8" field="controle_id"/>
    <alias name="ultimo_usuario" index="9" field="ultimo_usuario"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="ultimo_usuario" expression="'38'"/>
  </defaults>
  <constraints>
  ...
  <attributetableconfig sortOrder="1" actionWidgetStyle="dropDown" sortExpression="&quot;rev&quot;">
    <columns>
      <column name="id" type="field" hidden="0" width="176"/>
      <column type="actions" hidden="1" width="-1"/>
      <column name="observacao" type="field" hidden="0" width="-1"/>
      <column name="data_modificacao" type="field" hidden="0" width="191"/>
      <column name="controle_id" type="field" hidden="0" width="-1"/>
      <column name="ultimo_usuario" type="field" hidden="0" width="-1"/>
      <column name="obs" type="field" hidden="0" width="-1"/>
      <column name="categoria" type="field" hidden="0" width="-1"/>
      <column name="corrigido" type="field" hidden="0" width="-1"/>
  ...
  <editform tolerant="1">C:/Users/proc/AppData/Roaming/QGIS/QGIS3\profiles\default/python/plugins\Ferramentas_Producao\Tools\LoadData\forms\sisfron_sirgas2000_utm_21S_rev_vegetacao_p.ui</editform>
...
def formOpen(dialog, layer, featureid):
  ...
  <editable>
    ...
    <field name="obsoperador" editable="1"/>
    <field name="obsrevisor" editable="1"/>
    <field name="rev" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="obsoperador"/>
    <field labelOnTop="0" name="obsrevisor"/>
    <field labelOnTop="0" name="rev"/>
  ...
  <mapTip>[%format('Rev Nº.: %1 \nObs Rev\nObs Op.:',  "rev") +  "obsrevisor" + "obsoperador" %]</mapTip>
