        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Bairro" type="QString" value="10"/>
              <Option name="Distrito" type="QString" value="7"/>
              <Option name="Municipio" type="QString" value="6"/>
              <Option name="País" type="QString" value="4"/>
              <Option name="Região administrativa" type="QString" value="9"/>
              <Option name="Sub distrito" type="QString" value="8"/>
              <Option name="Unidade federacao" type="QString" value="5"/>
            </Option>
          </Option>
        </config>
      </editWidget>
