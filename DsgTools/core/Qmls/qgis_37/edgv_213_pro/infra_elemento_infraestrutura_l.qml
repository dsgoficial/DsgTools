...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Barragem" type="QString" value="1101"/>
              <Option name="Calha - Água pluvial" type="QString" value="1801"/>
              <Option name="Comporta" type="QString" value="901"/>
              <Option name="Condutor hídrico – calha" type="QString" value="201"/>
              <Option name="Condutor hídrico – tubulação" type="QString" value="202"/>
              <Option name="Correia transp - Grãos" type="QString" value="1902"/>
              <Option name="Correia transp - Minério" type="QString" value="1901"/>
              <Option name="Correia transp - Outros" type="QString" value="1998"/>
              <Option name="Duto - Desconhecido" type="QString" value="1700"/>
              <Option name="Duto - Efluentes" type="QString" value="1709"/>
              <Option name="Duto - Esgoto" type="QString" value="1710"/>
              <Option name="Duto - Gasolina" type="QString" value="1703"/>
              <Option name="Duto - Gás" type="QString" value="1708"/>
              <Option name="Duto - Nafta" type="QString" value="1707"/>
              <Option name="Duto - Outros" type="QString" value="1798"/>
              <Option name="Duto - Petróleo" type="QString" value="1706"/>
              <Option name="Duto - Querosene" type="QString" value="1705"/>
              <Option name="Duto - Água" type="QString" value="1701"/>
              <Option name="Duto - Álcool" type="QString" value="1704"/>
              <Option name="Duto - Óleo" type="QString" value="1702"/>
              <Option name="Eclusa" type="QString" value="1001"/>
              <Option name="Estação geradora - Eólica" type="QString" value="405"/>
              <Option name="Estação geradora - Hidrelétrica" type="QString" value="408"/>
              <Option name="Estação geradora - Maré-motriz" type="QString" value="407"/>
              <Option name="Estação geradora - Mista" type="QString" value="495"/>
              <Option name="Estação geradora - Outras" type="QString" value="498"/>
              <Option name="Estação geradora - Solar" type="QString" value="406"/>
              <Option name="Estação geradora - Termelétrica a carvão" type="QString" value="410"/>
              <Option name="Estação geradora - Termelétrica a diesel" type="QString" value="411"/>
              <Option name="Estação geradora - Termelétrica a gás" type="QString" value="412"/>
              <Option name="Estação geradora - Termelétrica nuclear" type="QString" value="409"/>
              <Option name="Galeria ou bueiro" type="QString" value="1501"/>
              <Option name="Linha de distribuição de energia" type="QString" value="302"/>
              <Option name="Linha de transmissão de energia" type="QString" value="303"/>
              <Option name="Molhe" type="QString" value="801"/>
              <Option name="Quebramar" type="QString" value="701"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="A SER PREENCHIDO" type="QString" value="999"/>
              <Option name="Adjacente a edificação" type="QString" value="17"/>
              <Option name="Elevado" type="QString" value="3"/>
              <Option name="Emerso" type="QString" value="4"/>
              <Option name="Isolada" type="QString" value="14"/>
              <Option name="Não aplicável" type="QString" value="97"/>
              <Option name="Sobre edificação" type="QString" value="18"/>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="material_construcao"/>
    <alias name="" index="5" field="posicao_relativa"/>
