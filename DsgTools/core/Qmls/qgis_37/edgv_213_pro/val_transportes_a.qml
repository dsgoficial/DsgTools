...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSize="12" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontWordSpacing="0" textColor="0,0,0,255" fontFamily="Noto Sans" fontLetterSpacing="0" blendMode="0" fontItalic="0" namedStyle="Regular" fontUnderline="0" isExpression="0" textOpacity="1" multilineHeight="1" fontCapitals="0" fieldName="obs" fontWeight="50">
        <text-buffer bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferOpacity="1" bufferDraw="0" bufferBlendMode="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1"/>
  ...
  <customproperties>
    ...
    <property key="variableValues">
      <value>2720-4_4_4</value>
      <value>SRID=31981;POLYGON((649646.468196572 7474190.86571627,645370.234742553 7474232.50746151,645414.469914036 7478845.87779646,649692.005549101 7478804.29532598,649646.468196572 7474190.86571627))</value>
      <value>{"uiData": {"layer_data": {"layer_schema": "edgv", "layer_name": "val_transportes_a", "layer_geom_type": "MULTIPOLYGON", "layer_fields": {"observacao": {}, "ultimo_usuario": {}, "data_modificacao": {}, "tipo_insumo": {"valueMap": {"Fotointerpretado": 1, "Insumo externo": 2, "Processo automático": 3, "Aquisição em campo": 4, "Mapeamento anterior": 5, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "tipo_comprovacao": {"valueMap": {"Confirmado em campo": 1, "Não possível de confirmar em campo": 2, "Feição não necessita de confirmação": 3, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "controle_id": {}, "obs": {}}, "group_geom": "AREA", "group_class": "val"}, "fields_sorted": ["observacao", "ultimo_usuario", "data_modificacao", "tipo_insumo", "tipo_comprovacao", "controle_id", "obs"], "form_name": "/home/hilverton/.local/share/QGIS/QGIS3/profiles/default/python/plugins/Ferramentas_Producao/Tools/LoadData/forms/sisfron_sirgas2000_utm_21S_val_transportes_a.ui"}}</value>
    </property>
  </customproperties>
  ...
  <DiagramLayerSettings linePlacementFlags="18" showAll="1" zIndex="0" priority="0" obstacle="0" placement="1" dist="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="tipo_comprovacao" index="2" field="tipo_comprovacao"/>
    <alias name="tipo_insumo" index="3" field="tipo_insumo"/>
    <alias name="observacao" index="4" field="observacao"/>
    <alias name="data_modificacao" index="5" field="data_modificacao"/>
    <alias name="controle_id" index="6" field="controle_id"/>
    <alias name="ultimo_usuario" index="7" field="ultimo_usuario"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="ultimo_usuario" expression="'33'"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="obs" type="field" hidden="0" width="305"/>
      ...
      <column name="area_otf" type="field" hidden="0" width="-1"/>
  ...
  <editform tolerant="1">/home/hilverton/.local/share/QGIS/QGIS3/profiles/default/python/plugins/Ferramentas_Producao/Tools/LoadData/forms/sisfron_sirgas2000_utm_21S_val_transportes_a.ui</editform>
