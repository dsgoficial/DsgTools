        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Limite Estadual" type="QString" value="2"/>
              <Option name="Limite Internacional" type="QString" value="1"/>
              <Option name="Limite Municipal" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
