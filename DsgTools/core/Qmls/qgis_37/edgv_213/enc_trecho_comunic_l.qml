...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Telefônica" type="QString" value="7"/>
              <Option name="Telegráfica" type="QString" value="6"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Fibra ótica" type="QString" value="25"/>
              <Option name="Fio Metálico" type="QString" value="26"/>
              <Option name="Outros" type="QString" value="99"/>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipotrechocomunic"/>
    ...
    <alias name="" index="9" field="emduto"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipotrechocomunic" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipotrechocomunic" desc=""/>
