...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="indice">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Auxiliar" type="QString" value="3"/>
              <Option name="Mestra" type="QString" value="1"/>
              <Option name="Normal" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="cota"/>
    <alias name="" index="3" field="depressao"/>
    <alias name="" index="4" field="indice"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="cota" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="depressao" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="indice" constraints="1" exp_strength="0"/>
