...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="4" field="desnivel"/>
    <alias name="" index="5" field="largura"/>
    <alias name="" index="6" field="extensao"/>
    <alias name="" index="7" field="calado"/>
    <alias name="" index="8" field="matconstr"/>
    <alias name="" index="9" field="operacional"/>
    <alias name="" index="10" field="situacaofisica"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="desnivel" constraints="0" exp_strength="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="calado" constraints="0" exp_strength="0"/>
