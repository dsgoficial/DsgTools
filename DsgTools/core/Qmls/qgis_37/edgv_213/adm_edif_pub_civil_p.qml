...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoedifcivil">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Assembléia Legislativa" type="QString" value="9"/>
              <Option name="Cartorial" type="QString" value="3"/>
              <Option name="Câmara Municipal" type="QString" value="8"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Eleitoral" type="QString" value="5"/>
              <Option name="Gestão" type="QString" value="4"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Policial" type="QString" value="1"/>
              <Option name="Prefeitura" type="QString" value="22"/>
              <Option name="Prisional" type="QString" value="2"/>
              <Option name="Produção e/ou pesquisa" type="QString" value="6"/>
              <Option name="Seguridade Social" type="QString" value="7"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Próprio nacional" type="QString" value="1"/>
              <Option name="Uso especial da União" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="tipoedifcivil"/>
    <alias name="" index="8" field="tipousoedif"/>
    <alias name="" index="9" field="id_org_pub_civil"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifcivil" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="tipousoedif" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_org_pub_civil" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoedifcivil" desc=""/>
    <constraint exp="" field="tipousoedif" desc=""/>
    <constraint exp="" field="id_org_pub_civil" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
