...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="6" field="posicaoreledific"/>
    <alias name="" index="7" field="ovgd"/>
    <alias name="" index="8" field="alturaestimada"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="posicaoreledific" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="ovgd" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="alturaestimada" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="posicaoreledific" desc=""/>
    <constraint exp="" field="ovgd" desc=""/>
    <constraint exp="" field="alturaestimada" desc=""/>
