...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Estação Agroclimatológica - AC" type="QString" value="3"/>
              <Option name="Estação Climatológica Auxiliar - CA" type="QString" value="2"/>
              <Option name="Estação Climatológica Principal - CP" type="QString" value="1"/>
              <Option name="Estação Evaporimétrica - EV" type="QString" value="6"/>
              <Option name="Estação Eólica - EO" type="QString" value="5"/>
              <Option name="Estação Fluviométrica - FL" type="QString" value="10"/>
              <Option name="Estação Maregráfica - MA" type="QString" value="11"/>
              <Option name="Estação Pluviométrica - PL" type="QString" value="4"/>
              <Option name="Estação Solarimétrica - SL" type="QString" value="7"/>
              <Option name="Estação de Marés Terrestres - Crosta" type="QString" value="12"/>
              <Option name="Estação de Radar Meteorológico - RD" type="QString" value="8"/>
              <Option name="Estação de Radiossonda - RS" type="QString" value="9"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="3" field="tipoptoestmed"/>
    <alias name="" index="4" field="codestacao"/>
    <alias name="" index="5" field="orgaoenteresp"/>
    <alias name="" index="6" field="id_est_med_fenomenos"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoptoestmed" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="codestacao" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="orgaoenteresp" constraints="0" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_est_med_fenomenos" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="id" desc=""/>
    <constraint exp="" field="nome" desc=""/>
    <constraint exp="" field="geometriaaproximada" desc=""/>
    <constraint exp="" field="tipoptoestmed" desc=""/>
    <constraint exp="" field="codestacao" desc=""/>
    <constraint exp="" field="orgaoenteresp" desc=""/>
    <constraint exp="" field="id_est_med_fenomenos" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
