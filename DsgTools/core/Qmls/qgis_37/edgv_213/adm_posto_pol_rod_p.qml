...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Posto PM" type="QString" value="20"/>
              <Option name="Posto PRF" type="QString" value="21"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="3" field="tipopostopol"/>
    <alias name="" index="4" field="geometriaaproximada"/>
    <alias name="" index="5" field="operacional"/>
    <alias name="" index="6" field="situacaofisica"/>
    <alias name="" index="7" field="id_org_pub_militar"/>
    <alias name="" index="8" field="id_org_pub_civil"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipopostopol" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipopostopol" desc=""/>
