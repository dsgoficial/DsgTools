...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipodepabast">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Caixa d`água" type="QString" value="2"/>
              <Option name="Cisterna" type="QString" value="3"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Não tratada" type="QString" value="7"/>
              <Option name="Tratada" type="QString" value="6"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipodepabast"/>
    <alias name="" index="5" field="situacaoagua"/>
    <alias name="" index="6" field="construcao"/>
    <alias name="" index="7" field="matconstr"/>
    <alias name="" index="8" field="finalidade"/>
    <alias name="" index="9" field="situacaofisica"/>
    <alias name="" index="10" field="operacional"/>
    <alias name="" index="11" field="id_complexo_abast_agua"/>
    <alias name="" index="12" field="id_org_ext_mineral"/>
    <alias name="" index="13" field="id_org_agropec_ext_veg_pesca"/>
    <alias name="" index="14" field="id_org_comerc_serv"/>
    <alias name="" index="15" field="id_org_industrial"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipodepabast" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="situacaoagua" constraints="1" exp_strength="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="id_complexo_abast_agua" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipodepabast" desc=""/>
    <constraint exp="" field="situacaoagua" desc=""/>
    ...
    <constraint exp="" field="id_complexo_abast_agua" desc=""/>
