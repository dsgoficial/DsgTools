...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Interferência com hidrografia" type="QString" value="4"/>
              <Option name="Interferência com localidades" type="QString" value="3"/>
              <Option name="Interferência com vias" type="QString" value="6"/>
              <Option name="Interferência com áreas especiais" type="QString" value="5"/>
              <Option name="Outras interferências" type="QString" value="7"/>
              <Option name="Risco geotécnico" type="QString" value="2"/>
              <Option name="Subestação de válvulas e/ou bombas" type="QString" value="1"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipolocalcrit"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipolocalcrit" constraints="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="tipolocalcrit" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
