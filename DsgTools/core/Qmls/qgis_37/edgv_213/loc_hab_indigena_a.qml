...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="4" field="coletiva"/>
    <alias name="" index="5" field="isolada"/>
    <alias name="" index="6" field="id_aldeia_indigena"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="coletiva" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="isolada" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_aldeia_indigena" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="coletiva" desc=""/>
    <constraint exp="" field="isolada" desc=""/>
    <constraint exp="" field="id_aldeia_indigena" desc=""/>
