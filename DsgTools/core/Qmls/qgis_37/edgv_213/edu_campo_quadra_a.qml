...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipocampoquadra">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Basquete" type="QString" value="2"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Futebol" type="QString" value="1"/>
              <Option name="Hipismo" type="QString" value="5"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Poliesportiva" type="QString" value="6"/>
              <Option name="Pólo" type="QString" value="4"/>
              <Option name="Tênis" type="QString" value="7"/>
              <Option name="Vôlei" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="6" field="tipocampoquadra"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipocampoquadra" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipocampoquadra" desc=""/>
