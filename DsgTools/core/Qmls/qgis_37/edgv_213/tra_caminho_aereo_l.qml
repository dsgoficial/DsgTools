...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Teleférico" type="QString" value="12"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipousocaminhoaer">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Cargas" type="QString" value="22"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Misto" type="QString" value="98"/>
              <Option name="Passageiros" type="QString" value="21"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipocaminhoaereo"/>
    <alias name="" index="5" field="tipousocaminhoaer"/>
    <alias name="" index="6" field="operacional"/>
    <alias name="" index="7" field="situacaofisica"/>
    <alias name="" index="8" field="id_org_ext_mineral"/>
    <alias name="" index="9" field="id_complexo_lazer"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipocaminhoaereo" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="tipousocaminhoaer" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipocaminhoaereo" desc=""/>
    <constraint exp="" field="tipousocaminhoaer" desc=""/>
