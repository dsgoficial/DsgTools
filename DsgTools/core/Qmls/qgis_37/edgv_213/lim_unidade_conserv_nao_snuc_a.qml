...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="4" field="atolegal"/>
    <alias name="" index="5" field="administracao"/>
    <alias name="" index="6" field="classificacao"/>
    <alias name="" index="7" field="anocriacao"/>
    <alias name="" index="8" field="sigla"/>
    <alias name="" index="9" field="areaoficial"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="classificacao" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="classificacao" desc=""/>
