...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipocemiterio">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Comum" type="QString" value="4"/>
              <Option name="Crematório" type="QString" value="1"/>
              ...
              <Option name="Parque" type="QString" value="2"/>
              <Option name="Túmulo Isolado" type="QString" value="5"/>
    ...
    <field name="denominacaoassociada">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Cristã" type="QString" value="5"/>
              <Option name="Israelita" type="QString" value="6"/>
              <Option name="Muçulmana" type="QString" value="7"/>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipocemiterio"/>
    <alias name="" index="5" field="denominacaoassociada"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipocemiterio" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="denominacaoassociada" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipocemiterio" desc=""/>
    <constraint exp="" field="denominacaoassociada" desc=""/>
