...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipobanco">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Cordão Arenoso" type="QString" value="4"/>
              <Option name="Fluvial" type="QString" value="1"/>
              <Option name="Lacustre" type="QString" value="3"/>
              <Option name="Marítimo" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="situacaoemagua">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Cobre e Descobre" type="QString" value="7"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Saibro" type="QString" value="24"/>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipobanco"/>
    <alias name="" index="5" field="situacaoemagua"/>
    <alias name="" index="6" field="materialpredominante"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipobanco" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="situacaoemagua" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipobanco" desc=""/>
    <constraint exp="" field="situacaoemagua" desc=""/>
