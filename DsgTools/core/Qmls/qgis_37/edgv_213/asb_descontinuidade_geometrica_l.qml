...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="motivodescontinuidade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Descontinuidade Temporal" type="QString" value="1"/>
              <Option name="Descontinuidade devido a transformação" type="QString" value="2"/>
              <Option name="Descontinuidade por diferente interpretação das classes" type="QString" value="5"/>
              <Option name="Descontinuidade por escala de insumo" type="QString" value="3"/>
              <Option name="Descontinuidade por excesso" type="QString" value="7"/>
              <Option name="Descontinuidade por falta de acurácia" type="QString" value="4"/>
              <Option name="Descontinuidade por omissão" type="QString" value="6"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="motivodescontinuidade"/>
    <alias name="" index="3" field="length_otf"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="motivodescontinuidade" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="motivodescontinuidade" desc=""/>
