...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Edificação Metro Ferroviária" type="QString" value="10"/>
              <Option name="Edificação rodoviária" type="QString" value="5"/>
              <Option name="Entroncamento" type="QString" value="8"/>
              <Option name="Galeria ou bueiro" type="QString" value="6"/>
              <Option name="Interrupção com a Moldura" type="QString" value="17"/>
              <Option name="Início ou fim de trecho" type="QString" value="9"/>
              <Option name="Localidade" type="QString" value="11"/>
              <Option name="Mudança de atributo" type="QString" value="7"/>
              <Option name="Passagem de nível" type="QString" value="13"/>
              <Option name="Passagem elevada ou viaduto" type="QString" value="2"/>
              <Option name="Patio" type="QString" value="12"/>
              <Option name="Ponte" type="QString" value="3"/>
              <Option name="Travessia" type="QString" value="4"/>
              <Option name="Túnel" type="QString" value="1"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="relacionado"/>
  </aliases>
