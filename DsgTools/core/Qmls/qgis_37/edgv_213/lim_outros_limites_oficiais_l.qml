...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Faixa de fronteira" type="QString" value="5"/>
              <Option name="Lateral marítima" type="QString" value="4"/>
              <Option name="Mar territorial" type="QString" value="1"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Plataforma continental jurídica" type="QString" value="6"/>
              <Option name="Zona contígua" type="QString" value="2"/>
              <Option name="Zona econômica exclusiva" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="6" field="tipooutlimofic"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipooutlimofic" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipooutlimofic" desc=""/>
