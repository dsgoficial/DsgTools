...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Fundeadouro com designação alfanumérica" type="QString" value="11"/>
              <Option name="Fundeadouro recomendado sem limite definido" type="QString" value="10"/>
              <Option name="Outros" type="QString" value="99"/>
              <Option name="Áreas de fundeio com limite definido" type="QString" value="12"/>
              <Option name="Áreas de fundeio proibido" type="QString" value="13"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="destinacaofundeadouro"/>
    <alias name="" index="5" field="administracao"/>
    <alias name="" index="6" field="id_complexo_portuario"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="destinacaofundeadouro" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="destinacaofundeadouro" desc=""/>
