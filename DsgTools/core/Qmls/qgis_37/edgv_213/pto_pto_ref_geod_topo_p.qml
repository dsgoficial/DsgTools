...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="proximidade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Adjacente" type="QString" value="15"/>
              <Option name="Coincidente" type="QString" value="16"/>
              <Option name="Desconhecida" type="QString" value="0"/>
              <Option name="Isolado" type="QString" value="14"/>
            </Option>
          </Option>
        </config>
      </editWidget>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Referência de Nível - RN" type="QString" value="2"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Nacional" type="QString" value="14"/>
              <Option name="Privada" type="QString" value="15"/>
            </Option>
          </Option>
        </config>
      </editWidget>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Não construído" type="QString" value="7"/>
  ...
  <aliases>
    ...
    <alias name="" index="14" field="nome"/>
    <alias name="" index="15" field="proximidade"/>
    <alias name="" index="16" field="tipoptorefgeodtopo"/>
    <alias name="" index="17" field="rede"/>
    <alias name="" index="18" field="referencialgrav"/>
    <alias name="" index="19" field="situacaomarco"/>
    <alias name="" index="20" field="datavisita"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="proximidade" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="tipoptorefgeodtopo" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="rede" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="referencialgrav" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="situacaomarco" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="datavisita" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="proximidade" desc=""/>
    <constraint exp="" field="tipoptorefgeodtopo" desc=""/>
    <constraint exp="" field="rede" desc=""/>
    <constraint exp="" field="referencialgrav" desc=""/>
    <constraint exp="" field="situacaomarco" desc=""/>
    <constraint exp="" field="datavisita" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
