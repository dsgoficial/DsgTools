...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="modalidade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Dados" type="QString" value="4"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Outras" type="QString" value="99"/>
              <Option name="Radiocomunicação" type="QString" value="1"/>
              <Option name="Radiodifusão/som" type="QString" value="5"/>
              <Option name="Radiodifusão/som e imagem" type="QString" value="2"/>
              <Option name="Telefonia" type="QString" value="3"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipoedifcomunic">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Central comutação e transmissão" type="QString" value="2"/>
              <Option name="Centro de operações" type="QString" value="1"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Estação radio-base" type="QString" value="3"/>
              <Option name="Estação repetidora" type="QString" value="4"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="modalidade"/>
    <alias name="" index="8" field="tipoedifcomunic"/>
    <alias name="" index="9" field="id_complexo_comunicacao"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="modalidade" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="tipoedifcomunic" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="0" unique_strength="0" field="id_complexo_comunicacao" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="modalidade" desc=""/>
    <constraint exp="" field="tipoedifcomunic" desc=""/>
    <constraint exp="" field="id_complexo_comunicacao" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
