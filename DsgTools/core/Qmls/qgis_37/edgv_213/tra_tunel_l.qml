...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipotunel">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Passagem subterrânea sob via" type="QString" value="2"/>
    ...
    <field name="modaluso">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Dutos" type="QString" value="7"/>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipotunel"/>
    ...
    <alias name="" index="9" field="nrpistas"/>
    <alias name="" index="10" field="nrfaixas"/>
    <alias name="" index="11" field="posicaopista"/>
    <alias name="" index="12" field="altura"/>
    <alias name="" index="13" field="extensao"/>
    <alias name="" index="14" field="length_otf"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipotunel" constraints="1" exp_strength="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="situacaofisica" constraints="0" exp_strength="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" field="altura" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipotunel" desc=""/>
    ...
    <constraint exp="" field="altura" desc=""/>
