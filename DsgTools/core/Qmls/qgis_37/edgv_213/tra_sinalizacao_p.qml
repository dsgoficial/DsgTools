...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tiposinal">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Barca farol" type="QString" value="5"/>
              <Option name="Bóia cega" type="QString" value="2"/>
              <Option name="Bóia de amarração" type="QString" value="3"/>
              <Option name="Bóia luminosa" type="QString" value="1"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Farol ou farolete" type="QString" value="4"/>
              <Option name="Sinalização de margem" type="QString" value="6"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tiposinal"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tiposinal" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tiposinal" desc=""/>
