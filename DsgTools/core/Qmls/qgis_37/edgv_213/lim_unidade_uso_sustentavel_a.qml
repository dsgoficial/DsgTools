...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipounidusosust">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Floresta - FLO" type="QString" value="3"/>
              <Option name="Reserva Extrativista - RESEX" type="QString" value="5"/>
              <Option name="Reserva Particular do Patrimônio Natural - RPPN" type="QString" value="7"/>
              <Option name="Reserva de Desenvolvimento Sustentável - RDS" type="QString" value="4"/>
              <Option name="Reserva de Fauna - REFAU" type="QString" value="6"/>
              <Option name="Área de Proteção Ambiental - APA" type="QString" value="1"/>
              <Option name="Área de Relevante Interesse Ecológico - ARIE" type="QString" value="2"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="anocriacao"/>
    <alias name="" index="5" field="sigla"/>
    <alias name="" index="6" field="areaoficialha"/>
    <alias name="" index="7" field="atolegal"/>
    <alias name="" index="8" field="administracao"/>
    <alias name="" index="9" field="tipounidusosust"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipounidusosust" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipounidusosust" desc=""/>
