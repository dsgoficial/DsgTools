...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <field name="tipoatracad">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="Cais" type="QString" value="38"/>
              <Option name="Cais flutuante" type="QString" value="39"/>
              <Option name="Desconhecido" type="QString" value="0"/>
              <Option name="Desembarcadouro" type="QString" value="44"/>
              <Option name="Dolfim" type="QString" value="43"/>
              <Option name="Molhe de atracação" type="QString" value="41"/>
              <Option name="Pier" type="QString" value="42"/>
              <Option name="Trapiche" type="QString" value="40"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="tipoatracad"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipoatracad" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipoatracad" desc=""/>
