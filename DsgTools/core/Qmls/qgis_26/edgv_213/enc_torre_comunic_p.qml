...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="posicaoreledific">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="17" type="QString" name="Adjacente a edificação"/>
              <Option value="14" type="QString" name="Isolado"/>
              <Option value="18" type="QString" name="Sobre edificação"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="posicaoreledific" index="6" name=""/>
    <alias field="ovgd" index="7" name=""/>
    <alias field="alturaestimada" index="8" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="posicaoreledific" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="posicaoreledific"/>
