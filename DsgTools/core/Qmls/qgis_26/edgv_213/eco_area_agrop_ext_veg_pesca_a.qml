...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="destinadoa">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="18" type="QString" name="Açaí"/>
              <Option value="41" type="QString" name="Babaçu"/>
              <Option value="37" type="QString" name="Carnaúba"/>
              <Option value="36" type="QString" name="Castanha"/>
              <Option value="38" type="QString" name="Coco"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="39" type="QString" name="Jaborandi"/>
              <Option value="35" type="QString" name="Látex"/>
              <Option value="5" type="QString" name="Madeira"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="40" type="QString" name="Palmito"/>
              <Option value="43" type="QString" name="Pecuária"/>
              <Option value="44" type="QString" name="Pesca"/>
              <Option value="34" type="QString" name="Turfa"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="destinadoa" index="2" name=""/>
    <alias field="id_org_agropec_ext_veg_pesca" index="3" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="destinadoa" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="destinadoa"/>
