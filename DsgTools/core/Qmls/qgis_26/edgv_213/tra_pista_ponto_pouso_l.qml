...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipopista">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="11" type="QString" name="Heliporto"/>
              <Option value="9" type="QString" name="Pista de pouso"/>
              <Option value="10" type="QString" name="Pista de táxi"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="12" type="QString" name="Militar"/>
              <Option value="6" type="QString" name="Particular"/>
              <Option value="11" type="QString" name="Público"/>
              <Option value="13" type="QString" name="Público/Militar"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipopista" index="4" name=""/>
    <alias field="revestimento" index="5" name=""/>
    <alias field="usopista" index="6" name=""/>
    <alias field="homologacao" index="7" name=""/>
    <alias field="operacional" index="8" name=""/>
    <alias field="situacaofisica" index="9" name=""/>
    <alias field="largura" index="10" name=""/>
    <alias field="extensao" index="11" name=""/>
    <alias field="id_complexo_aeroportuario" index="12" name=""/>
    <alias field="lenght_otf" index="13" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipopista" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="revestimento" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="usopista" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="homologacao" constraints="1" exp_strength="0" notnull_strength="1"/>
    ...
    <constraint unique_strength="0" field="id_complexo_aeroportuario" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipopista"/>
    <constraint exp="" desc="" field="revestimento"/>
    <constraint exp="" desc="" field="usopista"/>
    <constraint exp="" desc="" field="homologacao"/>
    ...
    <constraint exp="" desc="" field="id_complexo_aeroportuario"/>
