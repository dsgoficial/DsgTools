...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoedifrelig">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="3" type="QString" name="Centro"/>
              <Option value="5" type="QString" name="Convento"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="1" type="QString" name="Igreja"/>
              <Option value="6" type="QString" name="Mesquita"/>
              <Option value="4" type="QString" name="Mosteiro"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="7" type="QString" name="Sinagoga"/>
              <Option value="2" type="QString" name="Templo"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoedifrelig" index="7" name=""/>
    <alias field="ensino" index="8" name=""/>
    <alias field="religiao" index="9" name=""/>
    <alias field="id_org_religiosa" index="10" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_org_religiosa" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifrelig" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="ensino" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="religiao" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="id_org_religiosa" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoedifrelig"/>
    <constraint exp="" desc="" field="ensino"/>
    <constraint exp="" desc="" field="religiao"/>
    <constraint exp="" desc="" field="id_org_religiosa"/>
