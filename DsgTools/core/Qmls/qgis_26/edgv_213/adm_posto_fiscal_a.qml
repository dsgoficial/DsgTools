...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="11" type="QString" name="Fiscalização"/>
              <Option value="98" type="QString" name="Mista"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="10" type="QString" name="Tributação"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipopostofisc" index="6" name=""/>
    <alias field="id_org_pub_civil" index="7" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipopostofisc" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipopostofisc"/>
