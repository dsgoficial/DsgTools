    ...
    <field name="relacionado">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="4" type="QString" name="Depósito geral"/>
              <Option value="17" type="QString" name="Interrupção com a Moldura"/>
              <Option value="3" type="QString" name="Local crítico"/>
              <Option value="5" type="QString" name="Ponto de ramificação"/>
              <Option value="2" type="QString" name="Ponto final"/>
              <Option value="1" type="QString" name="Ponto inicial"/>
            </Option>
          </Option>
        </config>
      </editWidget>
