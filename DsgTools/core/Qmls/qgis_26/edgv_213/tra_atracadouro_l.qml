...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoatracad">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="38" type="QString" name="Cais"/>
              <Option value="39" type="QString" name="Cais flutuante"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="44" type="QString" name="Desembarcadouro"/>
              <Option value="43" type="QString" name="Dolfim"/>
              <Option value="41" type="QString" name="Molhe de atracação"/>
              <Option value="42" type="QString" name="Pier"/>
              <Option value="40" type="QString" name="Trapiche"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoatracad" index="4" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoatracad" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoatracad"/>
