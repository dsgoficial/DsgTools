...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tiposumvert">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="1" type="QString" name="Sumidouro"/>
              <Option value="2" type="QString" name="Vertedouro"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="causa">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="3" type="QString" name="Absorção"/>
              <Option value="1" type="QString" name="Canalização"/>
              <Option value="0" type="QString" name="Desconhecida"/>
              <Option value="2" type="QString" name="Gruta ou Fenda"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tiposumvert" index="4" name=""/>
    <alias field="causa" index="5" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tiposumvert" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="causa" constraints="1" exp_strength="0" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tiposumvert"/>
