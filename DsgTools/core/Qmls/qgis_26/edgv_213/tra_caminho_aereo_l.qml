...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="12" type="QString" name="Teleférico"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipousocaminhoaer">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="22" type="QString" name="Cargas"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="98" type="QString" name="Misto"/>
              <Option value="21" type="QString" name="Passageiros"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipocaminhoaereo" index="4" name=""/>
    <alias field="tipousocaminhoaer" index="5" name=""/>
    <alias field="operacional" index="6" name=""/>
    <alias field="situacaofisica" index="7" name=""/>
    <alias field="id_org_ext_mineral" index="8" name=""/>
    <alias field="id_complexo_lazer" index="9" name=""/>
    <alias field="length_otf" index="10" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipocaminhoaereo" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="tipousocaminhoaer" constraints="1" exp_strength="0" notnull_strength="1"/>
    ...
    <constraint unique_strength="0" field="id_complexo_lazer" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipocaminhoaereo"/>
    <constraint exp="" desc="" field="tipousocaminhoaer"/>
    ...
    <constraint exp="" desc="" field="id_complexo_lazer"/>
