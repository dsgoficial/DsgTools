...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipomassadagua">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="4" type="QString" name="Baía"/>
              <Option value="0" type="QString" name="Desconhecida"/>
              <Option value="5" type="QString" name="Enseada"/>
              <Option value="7" type="QString" name="Lago/Lagoa"/>
              <Option value="6" type="QString" name="Meandro Abandonado"/>
              <Option value="3" type="QString" name="Oceano"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="0" type="QString" name="Desconhecida"/>
              <Option value="1" type="QString" name="Doce"/>
              <Option value="2" type="QString" name="Salgada"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipomassadagua" index="4" name=""/>
    <alias field="regime" index="5" name=""/>
    <alias field="salinidade" index="6" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipomassadagua" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="regime" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="salinidade" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipomassadagua"/>
