...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoelemnat">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="11" type="QString" name="Cabo"/>
              <Option value="4" type="QString" name="Chapada"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="8" type="QString" name="Escarpa"/>
              <Option value="13" type="QString" name="Falésia"/>
              <Option value="5" type="QString" name="Maciço"/>
              <Option value="3" type="QString" name="Montanha"/>
              <Option value="2" type="QString" name="Morro"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="9" type="QString" name="Península"/>
              <Option value="6" type="QString" name="Planalto"/>
              <Option value="7" type="QString" name="Planície"/>
              <Option value="10" type="QString" name="Ponta"/>
              <Option value="12" type="QString" name="Praia"/>
              <Option value="1" type="QString" name="Serra"/>
              <Option value="14" type="QString" name="Talude"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoelemnat" index="4" name=""/>
    <alias field="length_otf" index="5" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoelemnat" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoelemnat"/>
