...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoaglomrurisol">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="6" type="QString" name="Aglomerado Rural Isolado - Núcleo"/>
              <Option value="5" type="QString" name="Aglomerado Rural Isolado - Povoado"/>
              <Option value="7" type="QString" name="Outros Aglomerados Rurais Isolados"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoaglomrurisol" index="10" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoaglomrurisol" constraints="1" exp_strength="0" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoaglomrurisol"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
