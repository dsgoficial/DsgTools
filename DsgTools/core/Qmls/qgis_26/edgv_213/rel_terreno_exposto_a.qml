...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="4" type="QString" name="Pedregoso"/>
              <Option value="24" type="QString" name="Saibro"/>
              <Option value="23" type="QString" name="Terra"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="causaexposicao">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="5" type="QString" name="Artificial"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="4" type="QString" name="Natural"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoterrexp" index="2" name=""/>
    <alias field="causaexposicao" index="3" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoterrexp" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="causaexposicao" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoterrexp"/>
    <constraint exp="" desc="" field="causaexposicao"/>
