...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoedifagropec">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="14" type="QString" name="Apiário"/>
              <Option value="13" type="QString" name="Aviário"/>
              <Option value="18" type="QString" name="Curral"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="17" type="QString" name="Pocilga"/>
              <Option value="12" type="QString" name="Sede operacional de fazenda"/>
              <Option value="15" type="QString" name="Viveiro de plantas"/>
              <Option value="16" type="QString" name="Viveiro para acquicultura"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifagropec" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoedifagropec"/>
