...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias field="desnivel" index="4" name=""/>
    <alias field="largura" index="5" name=""/>
    <alias field="extensao" index="6" name=""/>
    <alias field="calado" index="7" name=""/>
    <alias field="matconstr" index="8" name=""/>
    <alias field="operacional" index="9" name=""/>
    <alias field="situacaofisica" index="10" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="desnivel" constraints="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint unique_strength="0" field="calado" constraints="0" exp_strength="0" notnull_strength="0"/>
