...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="10" type="QString" name="Parada interestadual"/>
              <Option value="14" type="QString" name="Posto de fiscalização"/>
              <Option value="13" type="QString" name="Posto de pedágio"/>
              <Option value="12" type="QString" name="Posto de pesagem"/>
              <Option value="8" type="QString" name="Terminal interestadual"/>
              <Option value="9" type="QString" name="Terminal urbano"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoedifrod" index="7" name=""/>
    <alias field="administracao" index="8" name=""/>
    <alias field="id_estrut_apoio" index="9" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifrod" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoedifrod"/>
