...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias field="codigootto" index="4" name=""/>
    <alias field="nivelotto" index="5" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="codigootto" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="nivelotto" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="codigootto"/>
    <constraint exp="" desc="" field="nivelotto"/>
