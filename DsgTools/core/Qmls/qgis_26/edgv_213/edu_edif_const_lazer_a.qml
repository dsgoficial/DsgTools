...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoediflazer">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="5" type="QString" name="Anfiteatro"/>
              <Option value="7" type="QString" name="Centro cultural"/>
              <Option value="6" type="QString" name="Cinema"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="1" type="QString" name="Estádio"/>
              <Option value="2" type="QString" name="Ginásio"/>
              <Option value="3" type="QString" name="Museu"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="8" type="QString" name="Plataforma de pesca"/>
              <Option value="4" type="QString" name="Teatro"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoediflazer" index="7" name=""/>
    <alias field="id_complexo_lazer" index="8" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoediflazer" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoediflazer"/>
