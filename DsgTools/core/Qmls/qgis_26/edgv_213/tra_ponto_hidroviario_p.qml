    ...
    <field name="relacionado">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="24" type="QString" name="Atracadouro"/>
              <Option value="19" type="QString" name="Barragem"/>
              <Option value="22" type="QString" name="Complexo portuário"/>
              <Option value="21" type="QString" name="Confluência"/>
              <Option value="13" type="QString" name="Corredeira"/>
              <Option value="14" type="QString" name="Eclusa"/>
              <Option value="23" type="QString" name="Entre trechos hidroviários"/>
              <Option value="16" type="QString" name="Foz marítima"/>
              <Option value="17" type="QString" name="Interrupção com a Moldura"/>
              <Option value="12" type="QString" name="Queda dágua"/>
            </Option>
          </Option>
        </config>
      </editWidget>
