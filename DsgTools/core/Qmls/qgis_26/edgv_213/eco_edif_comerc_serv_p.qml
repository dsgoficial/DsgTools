...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoedifcomercserv">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="3" type="QString" name="Centro comercial"/>
              <Option value="5" type="QString" name="Centro de convenções"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="6" type="QString" name="Feira"/>
              <Option value="7" type="QString" name="Hotel/motel/pousada"/>
              <Option value="4" type="QString" name="Mercado"/>
              <Option value="99" type="QString" name="Outros"/>
              <Option value="8" type="QString" name="Restaurante"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="finalidade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="1" type="QString" name="Comercial"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="98" type="QString" name="Mista"/>
              <Option value="2" type="QString" name="Serviço"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoedifcomercserv" index="7" name=""/>
    <alias field="finalidade" index="8" name=""/>
    <alias field="id_org_comerc_serv" index="9" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoedifcomercserv" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoedifcomercserv"/>
