...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipounidusosust">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="3" type="QString" name="Floresta - FLO"/>
              <Option value="5" type="QString" name="Reserva Extrativista - RESEX"/>
              <Option value="7" type="QString" name="Reserva Particular do Patrimônio Natural - RPPN"/>
              <Option value="4" type="QString" name="Reserva de Desenvolvimento Sustentável - RDS"/>
              <Option value="6" type="QString" name="Reserva de Fauna - REFAU"/>
              <Option value="1" type="QString" name="Área de Proteção Ambiental - APA"/>
              <Option value="2" type="QString" name="Área de Relevante Interesse Ecológico - ARIE"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="anocriacao" index="4" name=""/>
    <alias field="sigla" index="5" name=""/>
    <alias field="areaoficialha" index="6" name=""/>
    <alias field="atolegal" index="7" name=""/>
    <alias field="administracao" index="8" name=""/>
    <alias field="tipounidusosust" index="9" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="atolegal" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="administracao" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="tipounidusosust" constraints="1" exp_strength="0" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="atolegal"/>
    <constraint exp="" desc="" field="administracao"/>
    <constraint exp="" desc="" field="tipounidusosust"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
