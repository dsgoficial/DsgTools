...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipocerr">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="1" type="QString" name="Cerrado"/>
              <Option value="2" type="QString" name="Cerradão"/>
              <Option value="0" type="QString" name="Desconhecido"/>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="tipocerr" index="6" name=""/>
    <alias field="classificacaoporte" index="7" name=""/>
    <alias field="area_otf" index="8" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipocerr" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipocerr"/>
