...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="6" type="QString" name="Sazonal"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="extensaotrecho" index="7" name=""/>
    <alias field="caladomaxseca" index="8" name=""/>
    <alias field="id_hidrovia" index="9" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="id_hidrovia" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="extensaotrecho" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="caladomaxseca" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="id_hidrovia" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="extensaotrecho"/>
    <constraint exp="" desc="" field="caladomaxseca"/>
    <constraint exp="" desc="" field="id_hidrovia"/>
