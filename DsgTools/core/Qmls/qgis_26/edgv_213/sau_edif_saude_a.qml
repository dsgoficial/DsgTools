...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <field name="tipoclassecnae">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="26" type="QString" name="85.11-1 Atendimento Hospitalar (Hospital)"/>
              <Option value="27" type="QString" name="85.12-0 Atendimento a Urgência e Emergências (Pronto Socorro)"/>
              <Option value="28" type="QString" name="85.13-8 Atenção Ambulatorial (Posto e Centro de Saúde)"/>
              <Option value="29" type="QString" name="85.14-6 Serviços de Complementação Diagnóstica ou Terapêutica"/>
              <Option value="30" type="QString" name="85.16-2 Outras Atividades Relacionadas com a Atenção à Saúde (Instituto de Pesquisa)"/>
              <Option value="31" type="QString" name="85.20-0 Serviços Veterinários"/>
              <Option value="0" type="QString" name="Desconhecido"/>
    ...
    <field name="nivelatencao">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="5" type="QString" name="Primário"/>
              <Option value="6" type="QString" name="Secundário"/>
              <Option value="7" type="QString" name="Terciário"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoclassecnae" index="7" name=""/>
    <alias field="nivelatencao" index="8" name=""/>
    <alias field="id_org_saude" index="9" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipoclassecnae" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="nivelatencao" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="id_org_saude" constraints="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tipoclassecnae"/>
    <constraint exp="" desc="" field="nivelatencao"/>
    <constraint exp="" desc="" field="id_org_saude"/>
