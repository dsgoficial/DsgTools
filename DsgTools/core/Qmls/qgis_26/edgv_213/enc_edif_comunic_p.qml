...
<qgis maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyDrawingTol="1" version="3.7.0-Master" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="1e+8" simplifyLocal="1" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="99" type="QString" name="Outras"/>
              <Option value="1" type="QString" name="Radiocomunicação"/>
              <Option value="5" type="QString" name="Radiodifusão/som"/>
              <Option value="2" type="QString" name="Radiodifusão/som e imagem"/>
              <Option value="3" type="QString" name="Telefonia"/>
            </Option>
          </Option>
        </config>
      </editWidget>
    ...
    <field name="tipoedifcomunic">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="2" type="QString" name="Central comutação e transmissão"/>
              <Option value="1" type="QString" name="Centro de operações"/>
              <Option value="0" type="QString" name="Desconhecido"/>
              <Option value="3" type="QString" name="Estação radio-base"/>
              <Option value="4" type="QString" name="Estação repetidora"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="modalidade" index="7" name=""/>
    <alias field="tipoedifcomunic" index="8" name=""/>
    <alias field="id_complexo_comunicacao" index="9" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="modalidade" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="tipoedifcomunic" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="id_complexo_comunicacao" constraints="0" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="modalidade"/>
    <constraint exp="" desc="" field="tipoedifcomunic"/>
    <constraint exp="" desc="" field="id_complexo_comunicacao"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
