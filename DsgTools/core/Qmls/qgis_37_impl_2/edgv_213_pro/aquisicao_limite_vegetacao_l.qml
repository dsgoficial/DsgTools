...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
    ...
    <symbols>
      <symbol name="0" force_rhr="0" type="line" alpha="1" clip_to_extent="1">
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          ...
          <prop k="line_color" v="35,255,35,255"/>
  ...
  <customproperties>
    ...
    <property key="variableValues">
      <value>2720-2_4_3</value>
      <value>SRID=31981;POLYGON((645634.494888293 7501912.40948396,641350.53690042 7501952.49660792,641393.023003543 7506565.67832637,645678.269524183 7506525.64926762,645634.494888293 7501912.40948396))</value>
      <value>{"uiData": {"layer_data": {"layer_schema": "edgv", "layer_name": "aquisicao_limite_vegetacao_l", "layer_geom_type": "MULTILINESTRING", "layer_fields": {"data_modificacao": {}, "tipo_comprovacao": {"valueMap": {"Confirmado em campo": 1, "Não possível de confirmar em campo": 2, "Feição não necessita de confirmação": 3, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "observacao": {}, "tipo_insumo": {"valueMap": {"Fotointerpretado": 1, "Insumo externo": 2, "Processo automático": 3, "Aquisição em campo": 4, "Mapeamento anterior": 5, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "ultimo_usuario": {}, "controle_id": {}}, "group_geom": "LINHA", "group_class": "aquisicao"}, "fields_sorted": ["data_modificacao", "tipo_comprovacao", "observacao", "tipo_insumo", "ultimo_usuario", "controle_id"], "form_name": "C:/Users/Proc/AppData/Roaming/QGIS/QGIS3\\profiles\\default/python/plugins\\Ferramentas_Producao\\Tools\\LoadData\\forms\\sisfron_sirgas2000_utm_21S_aquisicao_limite_vegetacao_l.ui"}}</value>
    </property>
  </customproperties>
  ...
  <aliases>
    ...
    <alias name="tipo_comprovacao" index="1" field="tipo_comprovacao"/>
    <alias name="tipo_insumo" index="2" field="tipo_insumo"/>
    <alias name="observacao" index="3" field="observacao"/>
  ...
  <editform tolerant="1">C:/Users/Proc/AppData/Roaming/QGIS/QGIS3\profiles\default/python/plugins\Ferramentas_Producao\Tools\LoadData\forms\sisfron_sirgas2000_utm_21S_aquisicao_limite_vegetacao_l.ui</editform>
