...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Área militar" type="QString" value="36"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="A SER PREENCHIDO" type="QString" value="999"/>
              <Option name="Contorno massa dágua" type="QString" value="2"/>
              ...
              <Option name="Massa dágua" type="QString" value="9"/>
  ...
  <aliases>
    ...
    <alias name="" index="5" field="tipo_comprovacao"/>
    <alias name="" index="6" field="tipo_insumo"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="tipo_delimitacao" expression=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" unique_strength="0" field="tipo_delimitacao" constraints="1" exp_strength="0"/>
    <constraint notnull_strength="1" unique_strength="0" field="geometria_aproximada" constraints="1" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="tipo_delimitacao" desc=""/>
