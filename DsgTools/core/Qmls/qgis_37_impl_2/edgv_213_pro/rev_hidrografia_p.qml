...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.7.0-Master" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+8" simplifyAlgorithm="0">
  ...
  <labeling type="rule-based">
    <rules key="{0bc70a28-c5b5-4dcc-b2e8-4f1a01d23aa1}">
      <rule key="{0e79f40a-0239-48ad-8863-205f5eeec684}" filter=" &quot;corrigido&quot; = 1">
      ...
      <rule key="{88b484ab-7186-4b2e-8eed-5b6bb92dbbdb}" filter="ELSE">
        <settings calloutType="simple">
  ...
  <customproperties>
    ...
    <property key="variableValues">
      <value>2721-4_1_1</value>
      <value>SRID=31981;POLYGON((687962.894477875 7459919.46217209,683690.0212149 7459972.20406011,683746.270758839 7464586.23513382,688020.453975854 7464533.56765952,687962.894477875 7459919.46217209))</value>
      <value>{"uiData": {"layer_data": {"layer_schema": "edgv", "layer_name": "rev_vegetacao_p", "layer_geom_type": "MULTIPOINT", "layer_fields": {"tipo_comprovacao": {"valueMap": {"Confirmado em campo": 1, "Não possível de confirmar em campo": 2, "Feição não necessita de confirmação": 3, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "categoria": {}, "tipo_insumo": {"valueMap": {"Fotointerpretado": 1, "Insumo externo": 2, "Processo automático": 3, "Aquisição em campo": 4, "Mapeamento anterior": 5, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}, "controle_id": {}, "data_modificacao": {}, "observacao": {}, "obs": {}, "ultimo_usuario": {}, "corrigido": {"valueMap": {"Sim": 1, "Não": 2, "A SER PREENCHIDO": 999, "IGNORAR": 10000}}}, "group_geom": "PONTO", "group_class": "rev"}, "fields_sorted": ["tipo_comprovacao", "categoria", "tipo_insumo", "controle_id", "data_modificacao", "observacao", "obs", "ultimo_usuario", "corrigido"], "form_name": "C:/Users/proc/AppData/Roaming/QGIS/QGIS3\\profiles\\default/python/plugins\\Ferramentas_Producao\\Tools\\LoadData\\forms\\sisfron_sirgas2000_utm_21S_rev_vegetacao_p.ui"}}</value>
    </property>
  </customproperties>
