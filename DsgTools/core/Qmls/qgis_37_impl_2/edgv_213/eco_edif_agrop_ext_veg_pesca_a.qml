...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" value="16" name="Viveiro para acquicultura"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="tipoedifagropec" name="" index="7"/>
    <alias field="id_org_agropec_ext_veg_pesca" name="" index="8"/>
  ...
  <defaults>
    ...
    <default field="tipoedifagropec" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipoedifagropec" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipoedifagropec" desc="" exp=""/>
