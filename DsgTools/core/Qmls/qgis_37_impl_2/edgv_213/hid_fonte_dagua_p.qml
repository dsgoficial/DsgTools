...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipofontedagua" name="" index="4"/>
    <alias field="qualidagua" name="" index="5"/>
    <alias field="regime" name="" index="6"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tipofontedagua" expression="" applyOnUpdate="0"/>
    <default field="qualidagua" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipofontedagua" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="qualidagua" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipofontedagua" desc="" exp=""/>
    <constraint field="qualidagua" desc="" exp=""/>
