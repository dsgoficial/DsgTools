...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipoelemnat" name="" index="4"/>
    <alias field="tiporocha" name="" index="5"/>
  ...
  <defaults>
    ...
    <default field="tipoelemnat" expression="" applyOnUpdate="0"/>
    <default field="tiporocha" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipoelemnat" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="tiporocha" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipoelemnat" desc="" exp=""/>
    <constraint field="tiporocha" desc="" exp=""/>
