...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipoterrexp" name="" index="2"/>
    <alias field="causaexposicao" name="" index="3"/>
  ...
  <defaults>
    ...
    <default field="tipoterrexp" expression="" applyOnUpdate="0"/>
    <default field="causaexposicao" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipoterrexp" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="causaexposicao" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipoterrexp" desc="" exp=""/>
    <constraint field="causaexposicao" desc="" exp=""/>
