...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="modalidade" name="" index="7"/>
    <alias field="tipoedifcomunic" name="" index="8"/>
  ...
  <defaults>
    ...
    <default field="modalidade" expression="" applyOnUpdate="0"/>
    <default field="tipoedifcomunic" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="modalidade" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="tipoedifcomunic" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="modalidade" desc="" exp=""/>
    <constraint field="tipoedifcomunic" desc="" exp=""/>
