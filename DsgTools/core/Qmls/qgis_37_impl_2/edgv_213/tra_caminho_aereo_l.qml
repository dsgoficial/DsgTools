...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipocaminhoaereo" name="" index="4"/>
    <alias field="tipousocaminhoaer" name="" index="5"/>
    <alias field="operacional" name="" index="6"/>
    <alias field="situacaofisica" name="" index="7"/>
    <alias field="id_org_ext_mineral" name="" index="8"/>
    <alias field="id_complexo_lazer" name="" index="9"/>
  ...
  <defaults>
    ...
    <default field="tipocaminhoaereo" expression="" applyOnUpdate="0"/>
    <default field="tipousocaminhoaer" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipocaminhoaereo" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="tipousocaminhoaer" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipocaminhoaereo" desc="" exp=""/>
    <constraint field="tipousocaminhoaer" desc="" exp=""/>
