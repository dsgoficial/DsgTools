...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="codigootto" name="" index="4"/>
    <alias field="nivelotto" name="" index="5"/>
  ...
  <defaults>
    ...
    <default field="codigootto" expression="" applyOnUpdate="0"/>
    <default field="nivelotto" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="codigootto" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="nivelotto" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="codigootto" desc="" exp=""/>
    <constraint field="nivelotto" desc="" exp=""/>
