...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="especie" name="" index="4"/>
    <alias field="posicaorelativa" name="" index="5"/>
    <alias field="operacional" name="" index="6"/>
    <alias field="situacaofisica" name="" index="7"/>
    <alias field="emduto" name="" index="8"/>
    <alias field="tensaoeletrica" name="" index="9"/>
    <alias field="numcircuitos" name="" index="10"/>
    <alias field="id_org_comerc_serv" name="" index="11"/>
    <alias field="lenght_otf" name="" index="12"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="especie" expression="" applyOnUpdate="0"/>
    ...
    <default field="emduto" expression="" applyOnUpdate="0"/>
    <default field="tensaoeletrica" expression="" applyOnUpdate="0"/>
    <default field="numcircuitos" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="especie" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    ...
    <constraint field="emduto" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="tensaoeletrica" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="numcircuitos" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="especie" desc="" exp=""/>
    <constraint field="posicaorelativa" desc="" exp=""/>
    <constraint field="operacional" desc="" exp=""/>
    <constraint field="situacaofisica" desc="" exp=""/>
    <constraint field="emduto" desc="" exp=""/>
    <constraint field="tensaoeletrica" desc="" exp=""/>
    <constraint field="numcircuitos" desc="" exp=""/>
