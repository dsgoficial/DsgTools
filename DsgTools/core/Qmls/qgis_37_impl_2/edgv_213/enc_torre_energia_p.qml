...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="ovgd" name="" index="6"/>
    <alias field="alturaestimada" name="" index="7"/>
    <alias field="tipotorre" name="" index="8"/>
    <alias field="arranjofases" name="" index="9"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tipotorre" expression="" applyOnUpdate="0"/>
    <default field="arranjofases" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="tipotorre" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="arranjofases" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="tipotorre" desc="" exp=""/>
    <constraint field="arranjofases" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
