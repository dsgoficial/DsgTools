...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipocombustivel" name="" index="12"/>
    <alias field="combrenovavel" name="" index="13"/>
    <alias field="tipomaqtermica" name="" index="14"/>
    <alias field="geracao" name="" index="15"/>
  ...
  <defaults>
    ...
    <default field="tipocombustivel" expression="" applyOnUpdate="0"/>
    <default field="combrenovavel" expression="" applyOnUpdate="0"/>
    <default field="tipomaqtermica" expression="" applyOnUpdate="0"/>
    <default field="geracao" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipocombustivel" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="combrenovavel" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="tipomaqtermica" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="geracao" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipocombustivel" desc="" exp=""/>
    <constraint field="combrenovavel" desc="" exp=""/>
    <constraint field="tipomaqtermica" desc="" exp=""/>
    <constraint field="geracao" desc="" exp=""/>
