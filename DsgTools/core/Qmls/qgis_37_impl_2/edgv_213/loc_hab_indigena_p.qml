...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="coletiva" name="" index="4"/>
    <alias field="isolada" name="" index="5"/>
    <alias field="id_aldeia_indigena" name="" index="6"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="coletiva" expression="" applyOnUpdate="0"/>
    <default field="isolada" expression="" applyOnUpdate="0"/>
    <default field="id_aldeia_indigena" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="coletiva" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="isolada" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="id_aldeia_indigena" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="coletiva" desc="" exp=""/>
    <constraint field="isolada" desc="" exp=""/>
    <constraint field="id_aldeia_indigena" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
