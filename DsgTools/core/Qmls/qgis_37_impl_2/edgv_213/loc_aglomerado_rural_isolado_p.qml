...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="geocodigo" name="" index="4"/>
    <alias field="identificador" name="" index="5"/>
    <alias field="latitude" name="" index="6"/>
    <alias field="latitude_gms" name="" index="7"/>
    <alias field="longitude" name="" index="8"/>
    <alias field="longitude_gms" name="" index="9"/>
    <alias field="tipoaglomrurisol" name="" index="10"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="identificador" expression="" applyOnUpdate="0"/>
    ...
    <default field="tipoaglomrurisol" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="identificador" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    ...
    <constraint field="tipoaglomrurisol" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="identificador" desc="" exp=""/>
    ...
    <constraint field="tipoaglomrurisol" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
