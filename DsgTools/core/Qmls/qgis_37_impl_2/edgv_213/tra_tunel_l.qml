...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipotunel" name="" index="4"/>
    ...
    <alias field="nrpistas" name="" index="9"/>
    <alias field="nrfaixas" name="" index="10"/>
    <alias field="posicaopista" name="" index="11"/>
    <alias field="altura" name="" index="12"/>
    <alias field="extensao" name="" index="13"/>
    <alias field="length_otf" name="" index="14"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tipotunel" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipotunel" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    ...
    <constraint field="situacaofisica" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    ...
    <constraint field="altura" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipotunel" desc="" exp=""/>
    ...
    <constraint field="altura" desc="" exp=""/>
