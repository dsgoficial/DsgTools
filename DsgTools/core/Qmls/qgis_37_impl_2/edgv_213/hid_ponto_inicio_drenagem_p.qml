...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
    ...
    <field name="relacionado">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option type="QString" value="14" name="Ponto início de drenagem"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="relacionado" name="" index="4"/>
    <alias field="nascente" name="" index="5"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="relacionado" expression="" applyOnUpdate="0"/>
    <default field="nascente" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="relacionado" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="nascente" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="relacionado" desc="" exp=""/>
    <constraint field="nascente" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
