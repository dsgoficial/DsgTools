...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="tipodepabast" name="" index="4"/>
    <alias field="situacaoagua" name="" index="5"/>
    <alias field="construcao" name="" index="6"/>
    <alias field="matconstr" name="" index="7"/>
    <alias field="finalidade" name="" index="8"/>
    <alias field="situacaofisica" name="" index="9"/>
    <alias field="operacional" name="" index="10"/>
    <alias field="id_complexo_abast_agua" name="" index="11"/>
    <alias field="id_org_ext_mineral" name="" index="12"/>
    <alias field="id_org_agropec_ext_veg_pesca" name="" index="13"/>
    <alias field="id_org_comerc_serv" name="" index="14"/>
    <alias field="id_org_industrial" name="" index="15"/>
    <alias field="area_otf" name="" index="16"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="tipodepabast" expression="" applyOnUpdate="0"/>
    <default field="situacaoagua" expression="" applyOnUpdate="0"/>
    ...
    <default field="id_complexo_abast_agua" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="tipodepabast" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    <constraint field="situacaoagua" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
    ...
    <constraint field="id_complexo_abast_agua" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="tipodepabast" desc="" exp=""/>
    <constraint field="situacaoagua" desc="" exp=""/>
    ...
    <constraint field="id_complexo_abast_agua" desc="" exp=""/>
