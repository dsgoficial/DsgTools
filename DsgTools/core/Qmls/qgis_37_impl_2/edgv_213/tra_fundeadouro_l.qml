...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="destinacaofundeadouro" name="" index="4"/>
    <alias field="administracao" name="" index="5"/>
    <alias field="id_complexo_portuario" name="" index="6"/>
  ...
  <defaults>
    ...
    <default field="destinacaofundeadouro" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="destinacaofundeadouro" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="destinacaofundeadouro" desc="" exp=""/>
