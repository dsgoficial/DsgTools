...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.7.0-Master" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="desnivel" name="" index="4"/>
    <alias field="largura" name="" index="5"/>
    <alias field="extensao" name="" index="6"/>
    <alias field="calado" name="" index="7"/>
    <alias field="matconstr" name="" index="8"/>
    <alias field="operacional" name="" index="9"/>
    <alias field="situacaofisica" name="" index="10"/>
    <alias field="length_otf" name="" index="11"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint field="desnivel" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    ...
    <constraint field="calado" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
