...
class IdentifyMissingPointsOnLineIntersections(ValidationAlgorithm):
    FLAGS = "FLAGS"
    ...
    def raiseFeaturesFlags(self, layer: QgsVectorLayer, feedback: QgsFeedback):
        ...
        flagText = self.tr("Missing intersection point.")
    ...
    def name(self):
        ...
        """
        return "identifymissingpointsonlineintersections"
    ...
    def displayName(self):
        ...
        """
        return self.tr("Identify Missing Points on Line Intersections")
    ...
    def tr(self, string):
        return QCoreApplication.translate(
            "IdentifyMissingPointsOnLineIntersections", string
        )
