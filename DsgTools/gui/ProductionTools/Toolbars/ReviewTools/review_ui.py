...
class Ui_ReviewToolbar(object):
    def setupUi(self, ReviewToolbar):
        ...
        self.zoomToNextCheckBox = QtWidgets.QCheckBox(self.tr('Zoom to next'), self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.zoomToNextCheckBox.sizePolicy().hasHeightForWidth())
        self.zoomToNextCheckBox.setSizePolicy(sizePolicy)
        self.zoomToNextCheckBox.setMinimumSize(QtCore.QSize(70, 20))
        self.zoomToNextCheckBox.setMaximumSize(QtCore.QSize(70, 20))
        self.zoomToNextCheckBox.setObjectName("zoomToNextCheckBox")
